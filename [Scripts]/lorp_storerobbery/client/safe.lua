...
local function safeIdleScene(coords, rotation, safe, bag)
    ...
    SetEntityRemoteSyncedScenesAllowed(cache.ped, true)
    SetEntityRemoteSyncedScenesAllowed(safe, true)
    SetEntityRemoteSyncedScenesAllowed(bag, true)
    ...
    Wait(667)
    NetworkStopSynchronisedScene(scene)
    SetEntityRemoteSyncedScenesAllowed(cache.ped, false)
    SetEntityRemoteSyncedScenesAllowed(safe, false)
    SetEntityRemoteSyncedScenesAllowed(bag, false)
    return true
end
