...
Config.SpeedUnit = "mph" -- Speed unit options: "kmh" or "mph"

Config.Notifications = {
    type = 'ox_lib', -- Options: 'ox_lib', 'esx', 'qb', 'qbx', 'wasabi', 'okok', 'custom', or 'none' ; Custom notification setup (scroll down here to add your custom notification code)
    title = 'Vehicle', -- Title for all notifications
    fasten = {
...
Config.Sounds = {
    ...
    unfasten = {
        ...
        volume = 0.5, -- Volume for unfasten sound (0.0 to 1.0)
    },
    alarm = {
        enabled = true, -- Enable/disable alarm sound
        volume = 0.3, -- Volume for alarm sound (0.0 to 1.0)
        speedThreshold = 50.0, -- Speed threshold for alarm
    }
}
...
Config.Ejection = {
    ...
    impactDamage = {
        low = {
            ejectChance = 20, -- Chance to eject when conditions are met (0-100)
            deathChance = 5, -- Chance to die on ejection (0-100), 0 = never die, 100 = always die
            ...
            survivalDamage = {10, 20}, -- Random damage range if you survive: randomly picks a value between 20 and 40 (health loss amount)
        ...
        high = {
            ejectChance = 80, -- Chance to eject when conditions are met (0-100)
            ...
            visualEffects = {
                ...
                heartbeat = {
                    ...
                    volume = 0.25, -- Volume for heartbeat sound (0.0 to 1.0)
                    duration = 10000, -- Duration for heartbeat sound in milliseconds
