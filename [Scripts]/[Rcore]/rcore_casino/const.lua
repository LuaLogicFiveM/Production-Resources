...
BlackjackTableDatas[0] = {
    ...
    MinimumBet = 10000,
    MaximumBet = 100000,
    DealerBlackjackPossibility = 8, -- 25% chance that dealer gets blackjack
    Dealer21Possibility = 5 -- 25% chance that dealer gets 21
}
...
BlackjackTableDatas[3] = {
    ...
    Dealer21Possibility = 4 -- 25% chance that dealer gets 21
}
...
BlackjackTableDatas[2] = {
    ...
    MaximumBet = 1000,
    DealerBlackjackPossibility = 10, -- 25% chance that dealer gets blackjack
    Dealer21Possibility = 8 -- 25% chance that dealer gets 21
}
...
RouletteTableDatas[0] = {
    ...
    TriggerUnluckyRoundFrom = 100000 -- always switch to unluckiest number if the spun number costs casino more than this
}
...
RouletteTableDatas[2] = {
    ...
    SpinDelayMax = 1,
    UnluckyRound = 3, -- each 6th round spins to the unluckiest number and costs casino the least
    TriggerUnluckyRoundFrom = 1000 -- always switch to unluckiest number if the spun number costs casino more than this
}
