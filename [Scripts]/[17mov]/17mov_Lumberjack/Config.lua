...
Config.RequireItemFromWholeTeam = false              -- If it's false, then only the host needs to have the required item, otherwise entire team needs it.
...
Config.RequiredAllPlayerClose = {
    enabled = true,
    distance = 20.0, -- Distance in which all players must be close to the job marker to start the job
}
...
Config.SoundsMultipler = 0.1        -- All sounds will be half of their default value. Range is 0.0-1.0
...
Config.GiveKeysToAllLobby = false                    -- Set to false if you want to give keys only to group creator while starting job
...
Config.BlipsStyles = {
    ...
    ["pickupPlanks"] = {
        color = 25,
        label = "~g~[LUMBERJACK]~s~ Pickup Processed Planks",
        sprite = 306,
        scale = 0.8
    },
    ...
    ["pickupChips"] = {
        color = 25,
        label = "~g~[LUMBERJACK]~s~ Pickup Processed Chips",
        sprite = 306,
        scale = 0.8
    },
    ...
    ["sellChips"] = {
        {
            ...
            pricePerPercent = math.random(75, 150),
            itemRewards = {
                -- {
    ...
    ["sellLogs"] = {
        {
            ...
            targetHeading = 270,
            pricePerLog = math.random(250, 750),
            itemRewards = {
                -- {
                --     item_name = "water_bottle",
                --     chance = 50,
    ...
    ["sellPlanks"] = {
        {
            ...
            pricePerPallete = math.random(2500, 7500),
            itemRewards = {
                -- {
                --     item_name = "water_bottle",
                --     chance = 50,
...
Config.Lang = {
    ...
    ['notAllPlayersClose'] = "Not all players are close to the job start point. Please wait for them",
}
...
Config.Sounds = {
    TreeFallingMaxDistance = 100,            -- Tree fall will be heard up to 75 meters
    ChainsawNoiseMaxDistance = 25,         -- Chainsaw Will be heard up to 250 meters
    logRollProcessing = 50,                 -- Log to planks processing will be heard up to 250 meters
}
