return {
    ...
    threshold = {
        health = 75.0,          -- Health difference needed to break off wheel (LastHealth - CurrentHealth)
        speed  = 75.0,          -- Speed difference needed to break off wheel (LastSpeed - CurrentSpeed)
        heavy  = 100.0,          -- Speed difference needed to disable vehicle instantly (LastSpeed - CurrentSpeed)
    },
