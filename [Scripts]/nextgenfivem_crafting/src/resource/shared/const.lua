...
BlueprintOptions = {
    item = 'blueprint',
    format = 'blueprint_%s' -- Format for blueprint items: %s will be replaced with the item name
}
...
DisableProximityCheck = true -- Disable the proximity check when interacting with the bench
...
PlayerCoordUpdateCooldown = 5000 -- How often to send player coordinates to the server (in milliseconds)
