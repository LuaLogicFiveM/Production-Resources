...
BenchOptions = {
    ...
    enablePortableBenches = false, -- Enable portable benches. This will allow the player to place the bench themselves with items. (this needs to be setted up, check out the documentation)
    enableBlueprintItems = true, -- Enable the blueprint items. The player will need to have the blueprint item in their inventory to craft the item. (this needs to be setted up, check out the documentation)
    colors = {
    ...
    blueprintDurability = { -- Only works if enableBlueprintItems and removeBlueprintOnCraft is enabled
        ...
        defaultUses = 1 -- The default uses of the blueprint
    },
    adminBenchAccess = false, -- Allow admins to use all benches
    kickPlayerOnDamage = false, -- Kick the player from the bench if they take damage
    blueprintStrictMode = true, -- The player must have a blueprint for every item they want to craft. (only works if enableBlueprintItems is enabled)
    ...
    queueLimit = 5, -- Maximum number of crafts a player can have in queue at the same time (0 = unlimited)
...
DiscordLogs = {
    ...
    webhookUrl = '', -- The webhook for the discord logs
}

EnableOXLibLogger = true -- Enable the ox_lib Logger.
