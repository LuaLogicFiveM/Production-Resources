...
RegisterNetEvent('ak47_khusbites:openbossaction', function()
    TriggerEvent('esx_society:openBossMenu', 'khusbites')
    TriggerEvent('society:openBossMenu', 'khusbites')
end)
...
AddEventHandler('ak47_khusbites:smoke', function()
...
AddEventHandler('ak47_khusbites:onuse:kushkrisps', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_khusbites:onuse:herbaldelightgummies', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_khusbites:onuse:blazebites', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_khusbites:onuse:chroniccrunchcookies', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_khusbites:onuse:hightimebrownies', function()
    effectid += 1
    effectHookah()
end)
...
RegisterNetEvent('ak47_khusbites:notify')
AddEventHandler('ak47_khusbites:notify', function(msg, type)
...
RegisterNetEvent('ak47_khusbites:progress')
AddEventHandler('ak47_khusbites:progress', function(msg, time)
    lib.progressCircle({
        duration = time,
        label = msg,
    })
