...
Citizen.CreateThread(function()
    ESX.TriggerServerCallback('ak47_whitewidowv2:getconfig', function(result)
        Config = result
    end)
...
RegisterNetEvent('ak47_whitewidowv2:openbossaction')
AddEventHandler('ak47_whitewidowv2:openbossaction', function()
    inBossMenu = false
    TriggerEvent('esx_society:openBossMenu', 'cookies', function(data, menu)
        menu.close()
    end)
...
RegisterNetEvent('ak47_whitewidowv2:notify')
AddEventHandler('ak47_whitewidowv2:notify', function(msg)
    ESX.ShowNotification(msg)
end)

RegisterNetEvent('ak47_whitewidowv2:progress')
AddEventHandler('ak47_whitewidowv2:progress', function(msg, time)
    lib.progressCircle({
        duration = time,
        label = msg,
    })
