...
DELETE FROM items WHERE name = 'gmo_cookies';
...
DELETE FROM items WHERE name = 'gmo_cookies_joint';
...
DELETE FROM items WHERE name = 'kushkrisps';
DELETE FROM items WHERE name = 'herbaldelightgummies';
DELETE FROM items WHERE name = 'blazebites';
DELETE FROM items WHERE name = 'chroniccrunchcookies';
DELETE FROM items WHERE name = 'hightimebrownies';

DELETE FROM items WHERE name = 'cafe_tequila';
DELETE FROM items WHERE name = 'cafe_khusbloom';
DELETE FROM items WHERE name = 'cafe_coffeebean';
DELETE FROM items WHERE name = 'cafe_sodawater';
DELETE FROM items WHERE name = 'cafe_mintleaves';
DELETE FROM items WHERE name = 'cafe_limejuice';
DELETE FROM items WHERE name = 'cafe_whisky';
DELETE FROM items WHERE name = 'cafe_whitewine';
DELETE FROM items WHERE name = 'cafe_redwine';
DELETE FROM items WHERE name = 'cafe_whiterum';
DELETE FROM items WHERE name = 'cafe_champagne';
DELETE FROM items WHERE name = 'cafe_shaker';
DELETE FROM items WHERE name = 'cafe_icecube';
DELETE FROM items WHERE name = 'cafe_lemonade';
DELETE FROM items WHERE name = 'cafe_vodka';
DELETE FROM items WHERE name = 'cafe_bluecuracao';


INSERT INTO `items` (`name`, `label`, `weight`) VALUES
	('cafe_tequila', 'Tequila', 1),
	('cafe_khusbloom', 'Dry Khus Bloom', 1),
	('cafe_coffeebean', 'Coffee Bean', 1),
	('cafe_sodawater', 'Coffee Bean', 1),
	('cafe_mintleaves', 'Mint Leaves', 1),
	('cafe_limejuice', 'Lime juice', 1),
	('cafe_whisky', 'Whisky', 1),
	('cafe_whitewine', 'Whitewine', 1),
	('cafe_redwine', 'Redwine', 1),
	('cafe_whiterum', 'White Rum', 1),
	('cafe_champagne', 'Champagne', 1),
	('cafe_shaker', 'Shaker', 1),
	('cafe_icecube', 'Ice Cube', 1),
	('cafe_lemonade', 'Lemonade', 1),
	('cafe_vodka', 'Vodka', 1),
	('cafe_bluecuracao', 'Blue Curacao', 1),
	
	('kushkrisps', 'Kush Krisps', 1),
	('herbaldelightgummies', 'Herbal Delight Gummies', 1),
	('blazebites', 'Blaze Bites', 1),
	('chroniccrunchcookies', 'Chronic Crunch Cookies', 1),
	('hightimebrownies', 'HighTime Brownies', 1),
	...
	('gmo_cookies_joint', 'GMO Cookies Joint', 1),
