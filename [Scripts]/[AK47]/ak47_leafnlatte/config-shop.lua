...
Config.AutoStock = {         -- auto stock for shop items
    ...
    add = 1,                -- add 1 item to the stock
}

Config.BossActions = vector3(186.96, -265.97, 53.94)    --Boss action menu location. esx_society required

Config.Shop = {
    blip = {enable = false, pos = vector3(191.73, -253.63, 53.97), name = 'High Society', sprite = 469, color = 16, size = 0.8, radius = 0.0, radius_color = 32},                                                           -- job name
    management = vector3(191.37, -255.98, 53.97),
    sell_coords = {                                    -- The coordinates where customes will buy things on this store (coordinates composed of x, y, z)
        {
            pos = vector3(192.62, -254.38, 53.97),
            radius = 1.0,
            pages = {
        ...
        {
            pos = vector3(192.32, -247.08, 53.96),
            radius = 2.5,
            pages = {
                [0] = {name = "Flavours", icon = 'fa-cookie-bite'},
                [1] = {name = "Backwoods", icon = 'fa-cookie-bite'},
    ...
    edibles = {
        {
            pos = vector3(187.12, -243.49, 53.4),
            boxHeading = 155.0,
            ...
            pos = vector3(185.22, -242.57, 53.4),
            boxHeading = 155.0,
            boxSize = vector3(1.0, 1.0, 3.0),
            refillHunger = 30,
            refillThirst = 30,
            ...
            pos = vector3(185.99, -246.06, 53.4),
            boxHeading = 155.0,
            boxSize = vector3(1.0, 1.0, 3.0),
            refillHunger = 30,
            refillThirst = 30,
            ...
            pos = vector3(184.08, -245.19, 53.4),
            boxHeading = 155.0,
            boxSize = vector3(1.0, 1.0, 3.0),
            refillHunger = 30,
            refillThirst = 30,
            ...
            pos = vector3(185.18, -253.83, 53.4),
            boxHeading = 155.0,
            boxSize = vector3(1.0, 1.0, 3.0),
            refillHunger = 30,
            refillThirst = 30,
