Locales['en'] = {
    ...
    notinj  = 'Your are not injured!',
    callrec  = 'Your call has been received and a doctor is coming from %s',
    docarrive  = 'Doctor will arrive:  \n%s seconds',
    alreadycalled  = 'Doctor is on the way',
    servnot  = 'This service is not available inside an interior!',

    suicide  = 'Suicide',
    npcorenv  = 'NPC / Environment',
    vehorunk  = 'Vehicle / Unknown',
    player  = 'Player [%s]',

    ui_incapacitated = 'INCAPACITATED',
    ui_incident_report = 'INCIDENT REPORT',
