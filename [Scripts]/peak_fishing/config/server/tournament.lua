return {
    ...
    rewards = {
        ...
        bonus = {
            ...
            items = {
                { name = 'minnow', amount = { min = 1, max = 3 }, chance = 25 },
                { name = 'nightcrawler', amount = { min = 1, max = 3 }, chance = 20 },
                { name = 'angelfish', amount = { min = 1, max = 3 }, chance = 15 },
                { name = 'squid', amount = { min = 1, max = 3 }, chance = 10 },
                { name = 'sturgeon', amount = { min = 1, max = 3 }, chance = 5 },
                { name = 'char', amount = { min = 1, max = 3 }, chance = 5 },
                { name = 'tilapia', amount = { min = 1, max = 3 }, chance = 5 },
                { name = 'tuna', amount = { min = 1, max = 3 }, chance = 5 },
            }
        }
    },
    ...
    discord = {
        ...
        webhook = {
            url = 'https://discord.com/api/webhooks/1309020755824087100/Jmvxbl22AjN8YY2aV9PNo5ix4fCSwYfqY5cSPt_IgsUyd_lpfJRYjidBvSC3QjMF9bdj',
