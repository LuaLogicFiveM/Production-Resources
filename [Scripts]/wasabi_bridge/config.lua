...
Config.Notifications = {
    defaults = {                                    -- Default notification settings
        position = 'top',                     -- position options: 'center', 'top-right', 'top-left', 'right', 'left', 'bottom-right', and 'bottom-left'
        time = 5000,                                -- Time in MS to show notifications by default if not defined
