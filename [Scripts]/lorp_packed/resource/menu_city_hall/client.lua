local Config = require 'resource/menu_city_hall/shared'
...
CreateThread(function()
        ...
        options = {
            {
                ...
                metadata = {
                    ...
                    { label = 'Sentence', value = '50 Months' },
                },
            },
            {
                ...
                metadata = {
                    ...
                    { label = 'Sentence', value = '30 Months' },
                },
            },
            {
    ...
    lib.registerContext({
        ...
        options = {
            {
                title = 'Altered Suspension',
                description = 'Prohibits raising or lowering a vehicle\'s front fenders more than four inches from the rear fenders. This law applies to passenger vehicles, including pickup trucks.',
                icon = 'circle',
                iconColor = '#30A038',
                metadata = {
                    { label = 'Class', value = 'Fine' },
    ...
    local leadership = {
        {
            name = 'Webby',
            rank = 'GSP | Commissioner'
        },
        {
            name = 'Plug',
            rank = 'GSP | Narcotics Commander'
        }
    }

    local lawyers = {
        {
            name = 'CREATE A TICKET IN DISCORD',
            phone = '000-000-0000'
        },
    }
    ...
    CreateThread(function()
        ...
        for i, lawyer in pairs(lawyers) do 
            table.insert(lawyerOptions, {
                title = lawyer.name,
                description = 'Number: '..lawyer.phone,
                ...
                onSelect = function()
                    ...
                    lib.notify({
                        ...
                        description = 'Lawyer details have been copied to your clipboard.',
                        showDuration = true,
                        position = 'top-right',
                        type = 'success',
                        iconColor = '#76A9D2'
    ...
    table.insert(options, {
        ...
        description = 'This will change your character name, nothing else will change or clear other than that.',
        icon = 'id-card',
        onSelect = function()
            exports.lorp_packed:nameChange()
        end,
    })
