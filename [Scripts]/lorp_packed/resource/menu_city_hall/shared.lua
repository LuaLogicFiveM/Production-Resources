return {
    ...
    text = {
        label = '[E] View Charges & Get Legal Assistance', -- only visible if useTarget is false
        size = 0.4,
        viewDistance = 3.0,
    },
    ...
    ped = {
        ...
        coords = vector4(1755.6791, 3805.3665, 35.4489, 127.6890),
    ...
    policeTitle = 'LEO Leadership',
    policeIcon = 'fa-shield',
    policeColor = '#1B5E94',

    chargesHeading = 'Charges & PINs',
    chargesTitle = 'List of Charges',
    chargesDescription = 'The list of charges and PINs below have been verified by the Police. Updated as of 01/01/25.',
...
------- TO REMOVE/ADD A MENU, FOLLOW THE FORMAT IN CLIENT.LUA, FAIRLY SELF-EXPLANATORY --------
    menu1 = {
        ...
        description = 'Last updated - 01/01/25',
