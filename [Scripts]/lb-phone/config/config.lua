...
Config.Logs.Dataset = "Phone" -- fivemanage dataset
Config.Logs.Actions = {
    Calls = true,
    Messages = true,
    InstaPic = true,
...
Config.Voice.SpatialAudioSubmixes = 4 -- the amount of submixes that are created for spatial audio
...
Config.Locations = { -- Locations that'll appear in the maps app.
    {
        position = vector2(2841.1575, 4733.4136),
        name = "Sheriff",
    ...
    {
        position = vector2(293.6984, -1407.4742),
        name = "Hospital",
...
Config.EndLiveClose = true -- should InstaPic live end when you close the phone?
...
Config.PromoteBirdy.Cost = 5000 -- how much does it cost to promote a post?
...
Config.Browser.CX = "f0948bf7382fa49e8" -- The CX id used to search with Google. You can get your own id from https://cse.google.com/cse/all
...
Config.Camera.Enabled = false -- use a custom camera that allows you to walk around while taking photos?
Config.Camera.Roll = false -- allow rolling the camera to the left & right?
Config.Camera.AllowRunning = false
...
Config.Camera.Vehicle.Zoom = false -- allow zooming in vehicles?
