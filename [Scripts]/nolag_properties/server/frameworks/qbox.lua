...
Framework = {
    ...
    GetPlayerFromId = function(source)
        ...
        xPlayer.addAccountMoney = function(type, money, reason)
            ...
            exports.qbx_core:AddMoney(qbPlayer.PlayerData.citizenid, type, money, reason)
        end
        ---------
        ...
        xPlayer.setMeta = function(key, val)
            return exports.qbx_core:SetMetadata(qbPlayer.PlayerData.citizenid, key, val)
        end
        ---------
        xPlayer.getMeta = function(key)
            return exports.qbx_core:GetMetadata(qbPlayer.PlayerData.citizenid, key)
        end
        ---------
        xPlayer.clearMeta = function(key)
            return exports.qbx_core:SetMetadata(qbPlayer.PlayerData.citizenid, key, nil)
        end
        return xPlayer
    end,
    GetPlayerFromIdentifier = function(citizenid)
        ...
        if not qbPlayer then
            qbPlayer = exports.qbx_core:GetOfflinePlayer(citizenid)
            ...
            return {
                ...
                ---------
                addAccountMoney = function(type, money, reason)
                    if type == 'money' then
                        type = 'cash'
                    end
                    exports.qbx_core:AddMoney(qbPlayer.PlayerData.citizenid, type, money, reason)
