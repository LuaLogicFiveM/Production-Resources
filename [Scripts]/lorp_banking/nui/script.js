...
const BankingApp = () => {
                        ...
                        <div className="atm-action-grid">
                            <div className="atm-action-card withdraw-card">
                                ...
                                <div className="quick-amounts">
                                    {[1000, 5000, 10000, 25000, 100000, 500000].map(amount => (
                                        <button
                                            key={amount}
    ...
    const renderDeposit = () => {
        ...
        const suggestedAmounts = [500, 1000, 5000, 10000, 25000, 500000];
    ...
    const renderSavings = () => {
        ...
        const suggestedAmounts = [1000, 5000, 10000, 25000, 500000];
