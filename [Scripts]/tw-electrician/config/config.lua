Config                       = {}
Locales                      = Locales or {}
Config.Framework             = 'esx'      -- esx, oldesx, qb, oldqb qb = qbox -- || type qb if you are using qbox
Config.Locale                = 'en'
Config.CurrencyUnit          = '$'       -- '€' -- '₺'  '$'
...
Config.Command               = {
    ...
    openTutorial = "electriciantutorial",
}
    ...
    ['regionData'] = {
        {
            ...
            vehicleSpawnCoords = {
                vehicleCoords = vector4(528.24, -1590.85, 29.28, 139.91),
                vehicleCoords2 = vector4(516.8, -1604.03, 29.3, 319.85),
            },
            regionJobTask = {
                {
                    id = 1,
...
Config.NotificationText   = {
    ...
    ['missionnotpermit'] = {
        text = Locales[Config.Locale]['missionnotpermit'],
        type = "errorNotify"
    },
}
