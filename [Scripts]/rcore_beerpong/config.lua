...
-- 3 = qbcore drunk
-- 4 = rcore_drunk
-- you can buy it here: https://store.rcore.cz/package/5161129
Config.DrunkSystem = "2"

-- this is how much drunk status we will give the player after he miss the cup the default value is 20%
Config.GiveDrunkValueAfterMissingCup = 20

-- using ox_inv?
Config.ox_inv = true

-- enable bet system? Will work only if framework isnt standalone
Config.EnableMoneyBet = true

-- Will remove cups if no one near
Config.RemoveCupsIfNoOneNear = true
...
Config.OnlyAuthorCanQuit = false
