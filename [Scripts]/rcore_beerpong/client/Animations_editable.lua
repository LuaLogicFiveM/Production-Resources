function PlayWinnerPedAnimation()
    ...
    TriggerEvent('rcore_stats:api:increaseStatValue', "beerpong_won", 1)
...
function PlayScorePedAnimation()
    ...
    TriggerEvent('rcore_stats:api:increaseStatValue', "beerpong_hit", 1)
...
function PlayPedMissAnimation()
    ...
    CreateThread(function()
        ...
        Wait(200)
        Wait(33)
        GiveDrunkValue(Config.GiveDrunkValueAfterMissingCup or 20)
