...
Config.Language = {
    ...
    cantPromoteSelf = "You can\'t manage yourself",
    notInCity = 'Player not Found',
    cantPromote = "You cannot promote to this rank!",
    plyPromoted = "You have been promoted",
    plyPromoted2 = "Sucessfulluy promoted!",
    offlinePromote = "You cant change offline player's rank",
    plyHired = "You Hired ",
    plyHired2 = "You were hired as ",
    moneyWithdraw = "You have withdrawn: $",
    moneyDeposit = "You have deposited: $",
    notEnoughMoney = "Not enough money in account!",
    noAccountMoney = 'Withdrawal amount exceeds',
