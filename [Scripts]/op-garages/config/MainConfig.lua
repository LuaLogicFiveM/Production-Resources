...
Config.FuelDependency = "lc_fuel" -- Options: none, cdn-fuel, ox-fuel, LegacyFuel, qs-fuel, rcore-fuel, codem-xfuel, lc_fuel, stg-fuel
Config.KeysDependency = "wasabi_carlock" -- Options: none, 0r-vehiclekeys, msk_vehiclekeys, jaksam_keys, brutal_keys, wx_carlock, qs-keys, qb-keys, qbx_vehiclekeys, wasabi_carlock, sna-vehiclekeys, dusa_vehiclekeys, Renewed-Vehiclekeys, tgiann-keys, ak47_vehiclekeys, ak47_qb_vehiclekeys, MrNewbVehicleKeys, mVehicle, sy_carkeys, old-qb-keys, p_carkeys, custom-qb-keys (set it when other qb-keys are not working)
...
Config.SubOwners = {
    ...
    Command = "givecarkey", -- Command Name
...
Config.AdminMenu = {
    ...
    PlateChangerCommand = "garageplate", -- Plate changer command.
    DeleteVehicle = "garagedelete", -- Permamently Delete car from database.
    AddCarCommand = "garageaddcar", -- Add car to database.
    AddJobCarCommand = "garagejobcar", -- Add job car to database.
    AddGangCarCommand = "garagegangcar", -- Add gang car to database.
}
...
Config.IV = {
    ...
    maxPriceBeforeImpoundDate = 50000,  -- Maximum fee for releasing a vehicle before the impound date.
    timeOptions = {
