...
Config.RefuelTick = 800                 -- Time in ms to refuel 0.5L of fuel in the vehicle (lower values means faster refuel)
...
Config.FuelConsumptionChart = {
    ...
    focusShortcut = "",       -- Shortcut to set the UI focus to the dialog
...
Config.CustomGasPumpLocations = {
    ...
    { prop = "prop_gas_pump_1b", location = vector4(3820.6768, 5246.8120, 16.6259, 177.7757), ropeLength = 14.0 },
    { prop = "prop_gas_pump_1b", location = vector4(2278.0415, -3189.5593, 21.8200, 91.8242), ropeLength = 14.0 },
    { prop = "prop_gas_pump_1b", location = vector4(-2978.9192, 4282.1494, 23.8779, 75.2908), ropeLength = 14.0 },
    { prop = "prop_gas_pump_1b", location = vector4(-2295.2410, 5058.7290, 40.6968, 116.3190), ropeLength = 14.0 },
    { prop = "prop_gas_pump_1b", location = vector4(3641.0186, -907.5805, 31.0233, 179.9247), ropeLength = 14.0 },
}
