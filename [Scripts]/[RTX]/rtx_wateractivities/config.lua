...
Config.WaterActivitiesViaItem = true -- if you enable this feature, activities can only be spawned via item. Only works for qbcore and esx! (you can edit other.lua to create item for other frameworks)

Config.WaterActivitiesViaCommand = false -- if you enable this feature, activities can only be spawned via command. Commands is writed in Config.WaterActivitiesSpawnableCommands
...
Config.SandCastlesBuild = false -- enable this if you want to allow players to build sand castles
...
Config.SandCastlesBuildDuration = 2 -- in seconds
...
Config.FallingFromAttractionsReactionTime = 1500 -- maximum time at which the player must react in order not to fall (in miliseconds)

Config.FallingFromAttractionsReactionWatingTime = 2000 -- the time it takes for the reaction to appear (in miliseconds)
...
Config.AttractionsSettings = {
	...
	scootercars = {
		...
		scootermodel = "seashark", -- vehicle model of scooter
		...
		blip = {
			...
			bliptext = "Jetski Rental", -- text of blip
		},		
		marker = {
...
Config.ReactionLetters = { -- letters for reaction
	{reactionkey = "E", keyid = 38},
	{reactionkey = "H", keyid = 74},
	{reactionkey = "U", keyid = 303},
	{reactionkey = "K", keyid = 311},
	{reactionkey = "W", keyid = 32},
	{reactionkey = "A", keyid = 34},
...
function Notify(text)
	exports["ox_lib"]:notify({title = "Water Activities", description = text, duration = 5000, type = "info"}) -- if you get error in this line its because you dont use our notify system buy it here https://rtx.tebex.io/package/5402098 or you can use some other notify system just replace this notify line with your notify system
