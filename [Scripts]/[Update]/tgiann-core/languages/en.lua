configCore.langs.en = {
    ...
    changeLanguageCommand = {
        ...
        paramDesc = "Enter language abbreviation (e.g., tr, en)",
        langNotFound = "Language not found with this abbreviation",
        changed = "Language changed to %s",
    },
    company = {
        ...
        command             = {
            removeCommandDesc      = "Use the command to remove an ownable location",
            removeCommandParamDesc = "Enter the company keyName(found in tgiann_core_player_ownable database table)",
            removeCommandNotFound  = "Company not found with this keyName",
            removeCommandSuccess   = "Company %s successfully removed",
        }
    },
    log = {
        company = {
