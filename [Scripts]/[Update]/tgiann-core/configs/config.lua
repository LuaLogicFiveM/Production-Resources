...
configCore.tgiannDrawText3D          = false                                          -- Use tgiann's drawtext3d function instead of QB and ESX
configCore.checkArtifactVersion      = false                                          -- Check the artifact version of the server
