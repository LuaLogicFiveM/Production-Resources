...
-- Admin Settings
Config.AdminAcePermission = "group.tmod"
...
Config.Permissions = {
    groups = {
        tmod = {
            label = "T-Mod",
            permissions = {
                "view_reports", "claim_report", "resolve_report", "delete_report", "set_priority",
                "send_admin_message", "view_notes", "manage_notes", "freeze_player", "teleport_to",
                "bring_player", "heal_player", "revive_player", "view_player_history", "view_statistics",
                "spectate_player"
            }
        },
        mod = {
        ...
        owner = {
            label = "Owner",
            inherits = "manager",
            permissions = {"ragdoll_player", "kick_player", "manage_inventory"} -- inherits everything from manager
        }
    },
...
-- Screenshot Settings
Config.Screenshot = {
    provider = "screencapture",  -- "screenshot-basic" or "screencapture"
    encoding = "webp",               -- "jpg", "png", or "webp" (webp only with screencapture)
