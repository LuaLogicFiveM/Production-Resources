...
-------------------------------Important Configs---------------------------------
---------------------------------------------------------------------------------
SDC.Target = "ox_target" --Can be one of these (If "none" is selected it will use TextUi): ["qb-target","ox_target","none"]
...
SDC.MaxStillSomeoneCanPlace = 3 --How many still a single player can place at a time
...
SDC.CreateStillSmoke = { --All smoke particle configs
    ...
    DistToDraw = 75 --How close/far you have to be for it to create/delete the smoke particle
}
---------------------------------------------------------------------------------
-------------------------------Animation Configs---------------------------------
---------------------------------------------------------------------------------
...
SDC.MinMaxSellAmount = {1, 5} --The Minimum/Maximum amount of moonshine that can be sold at a time
...
SDC.OldManSpawns = { --All old man spawn locations (will select random location out of table on every server restart)
    --EX: vec4(0.0, 0.0, 0.0, 0.0)
    vec4(-32.1563, 3032.4221, 41.0572, 242.4400),
}
...
SDC.Stores = { --All Store configs
    {
        Label = "Moonshine: Farmers Market",
    ...
    {
        Label = "Moonshine: Log Market",
        PedModel = "a_m_m_farmer_01",
        Coords = vec4(839.4160, 2176.7979, 52.2893, 155.1686),
