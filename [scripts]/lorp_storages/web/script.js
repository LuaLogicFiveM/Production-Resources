    ...
    switch (data.action) {
        ...
        case 'shareAccessResponse':
            ...
            if (data.data && data.data.success) {
                ...
                fetch(`https://lorp_storages/getSharedAccess`, {
                    method: 'POST',
                    headers: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('buy-new-storage-btn').addEventListener('click', function() {
        fetch(`https://lorp_storages/closeUI`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
            ...
            setTimeout(() => {
                fetch(`https://lorp_storages/showPurchaseUI`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
...
function createStorageCard(unit) {
    ...
    manageBtn.addEventListener('click', function(e) {
        e.stopPropagation();
        fetch(`https://lorp_storages/openStorageManagement`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    openBtn.addEventListener('click', function(e) {
        ...
        fetch(`https://lorp_storages/openStorage`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
function purchaseStorage() {
    ...
    fetch(`https://lorp_storages/purchaseStorage`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function renameStorage() {
    ...
    fetch(`https://lorp_storages/renameStorage`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function changeIcon() {
    ...
    fetch(`https://lorp_storages/changeIcon`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function upgradeStorage() {
    fetch(`https://lorp_storages/upgradeStorage`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function addAccess() {
    ...
    fetch(`https://lorp_storages/shareAccess`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function removeAccess(identifier) {
    fetch(`https://lorp_storages/removeAccess`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
