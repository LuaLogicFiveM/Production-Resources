...
Config.Command = 'time' --The command for staff to open the UI.
Config.ConsolePrints = false --Do you want the console to print the weather changes?
...
Config.TsunamiWarning = {
    ...
    time = 3 --(in minutes) How long the tsunami warning should last. Read the docs for more info.
}
...
Config.Weather = {
    ...
    GameWeather = { --If you chose 'game', you have the following configurable options:
        ...
        rain_chance = 15, --Chance of rain (0-100%) if the rain WeatherGroup is randomly selected.
        thunder_chance = 20, --Chance of thunder during rain (0-100%).
        fog_chance = 1, --Chance of fog (0-100%) if the fog WeatherGroup is randomly selected.
        snow_chance = 15, --Chance of snow (0-100%) if the rain WeatherGroup is randomly selected.
