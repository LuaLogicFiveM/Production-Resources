...
---@param ... any
GA.CB.TriggerServerCallback = function(eventName, callback, ...)
	serverRequests[RequestId] = callback

	TriggerServerEvent(
		getResourceName() .. ":triggerServerCallback",
		eventName,
		RequestId,
...
---@param eventName string
---@param callback function
GA.CB.RegisterClientCallback = function(eventName, callback)
	clientCallbacks[eventName] = callback
end

RegisterNetEvent(getResourceName() .. ":triggerClientCallback", function(eventName, requestId, invoker, ...)
	...
	clientCallbacks[eventName](function(...)
		TriggerServerEvent(getResourceName() .. ":clientCallback", requestId, invoker, ...)
	end, ...)
end)
