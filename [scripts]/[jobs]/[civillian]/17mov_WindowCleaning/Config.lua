...
Config.GiveKeysToAllLobby = false                -- Set to false if you want to give keys only for group creator while starting job
...
Config.RequireItemFromWholeTeam = false              -- If it's false, then only host needs to have the required item, otherwise all team needs it.
