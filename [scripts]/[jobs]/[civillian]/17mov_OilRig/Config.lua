...
Config.OneGasPercentWorth = math.random(50, 75)                     -- How much script should pay for one percent of collected gas.
Config.OneQuestPercentWorth = math.random(150, 225)                    -- How much script should pay for one percent of side quests done.
...
Config.SoundVolumeMultipler = 0.2                   -- Here you can change sounds volume multipler
Config.RequireAllTeamOnRig = false                   -- Here you force that everyone from lobby needs to be at rig to perform any work action
...
Config.BlipsStyles = {
    EndJob = {
        label = "~b~[OIL RIG]~s~ End Job",
        sprite = 1,
        scale = 1.0,
        color = 26,
    },
    Boat = {
        label = "~b~[OIL RIG]~s~ Boat Location",
        sprite = 1,
        scale = 1.0,
        color = 26,
    },
    Containers = {
        label = "~b~[OIL RIG]~s~ Container to load",
        sprite = 1,
        scale = 0.6,
        color = 26,
    },
    Rig = {
        label = "~b~[OIL RIG]~s~ Rig",
        sprite = 1,
        scale = 1.0,
        color = 26,
    },
    CarryingProp = {
        label = "~b~[OIL RIG]~s~ Delivery Destination",
        sprite = 1,
        scale = 1.0,
        color = 26,
    },
    Drilling = {
        label = "~b~[OIL RIG]~s~ Drilling Task",
        sprite = 1,
        scale = 1.0,
        color = 26,
    },
    Welding = {
        label = "~b~[OIL RIG]~s~ Welding Task",
        sprite = 1,
        scale = 1.0,
        color = 26,
    },
