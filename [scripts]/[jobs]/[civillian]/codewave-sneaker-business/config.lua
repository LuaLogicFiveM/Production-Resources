...
Config.RequiredItems = {
    { item = 'sky_gliders_plus', priceMin = 360, priceMax = 385 },
    { item = 'breeze_bangs', priceMin = 325, priceMax = 355 },
    { item = 'tiger_mediums', priceMin = 325, priceMax = 355 },
    { item = 'galaxy_x', priceMin = 430, priceMax = 460 },
    { item = 'sky_walkers', priceMin = 260, priceMax = 290 },
    { item = 'sky_pilots', priceMin = 325, priceMax = 355 },
    { item = 'sky_flyers', priceMin = 325, priceMax = 355 },
    { item = 'sky_gliders', priceMin = 420, priceMax = 450 },
    { item = 'fastrunner_2000', priceMin = 360, priceMax = 385 },
    { item = 'speedster_300', priceMin = 290, priceMax = 320 },
    { item = 'runner_prime', priceMin = 325, priceMax = 355 },
    { item = 'breeze_95s', priceMin = 360, priceMax = 385 },
    { item = 'breeze_100s', priceMin = 360, priceMax = 385 },
    { item = 'breeze_90s', priceMin = 325, priceMax = 355 },
    { item = 'sky_walkers_red', priceMin = 325, priceMax = 355 },
    { item = 'shadow_yellows', priceMin = 360, priceMax = 385 },
    
    --- We reccommend increasing the verified shoes.
    { item = 'sky_gliders_plus_verified', priceMin = 430, priceMax = 460 },
    { item = 'breeze_bangs_verified', priceMin = 390, priceMax = 430 },
    { item = 'tiger_mediums_verified', priceMin = 390, priceMax = 430 },
    { item = 'galaxy_x_verified', priceMin = 520, priceMax = 550 },
    { item = 'sky_walkers_verified', priceMin = 310, priceMax = 350 },
    { item = 'sky_pilots_verified', priceMin = 390, priceMax = 430 },
    { item = 'sky_flyers_verified', priceMin = 390, priceMax = 430 },
    { item = 'sky_gliders_verified', priceMin = 500, priceMax = 540 },
    { item = 'fastrunner_2000_verified', priceMin = 430, priceMax = 460 },
    { item = 'speedster_300_verified', priceMin = 350, priceMax = 380 },
    { item = 'runner_prime_verified', priceMin = 390, priceMax = 430 },
    { item = 'breeze_95s_verified', priceMin = 430, priceMax = 460 },
    { item = 'breeze_100s_verified', priceMin = 430, priceMax = 460 },
    { item = 'breeze_90s_verified', priceMin = 390, priceMax = 430 },
    { item = 'sky_walkers_red_verified', priceMin = 390, priceMax = 430 },
    { item = 'shadow_yellows_verified', priceMin = 430, priceMax = 460 },
}
