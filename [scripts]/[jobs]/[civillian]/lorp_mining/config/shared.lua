return {
    ...
    shops = {
        ...
        pawn = {
            ...
            account = 'cash',
            items = {
                [1] = { item = 'ls_coal_ore', price = math.random(25, 50), icon = 'hand-holding-dollar' },
                [2] = { item = 'ls_copper_ore', price = math.random(35, 55), icon = 'hand-holding-dollar' },
                [3] = { item = 'ls_iron_ore', price = math.random(35, 65), icon = 'hand-holding-dollar' },
                [4] = { item = 'ls_silver_ore', price = math.random(40, 70), icon = 'hand-holding-dollar' },
                [5] = { item = 'ls_gold_ore', price = math.random(100, 150), icon = 'hand-holding-dollar' },
                [6] = { item = 'ls_copper_ingot', price = math.random(75, 100), icon = 'hand-holding-dollar' },
                [7] = { item = 'ls_iron_ingot', price = math.random(100, 125), icon = 'hand-holding-dollar'},
                [8] = { item = 'ls_silver_ingot', price = math.random(350, 500), icon = 'hand-holding-dollar' },
                [9] = { item = 'ls_gold_ingot', price = math.random(250, 500), icon = 'hand-holding-dollar' },
            }
        },
        blip = {
