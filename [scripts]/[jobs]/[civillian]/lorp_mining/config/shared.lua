return {
    ...
    shops = {
        ...
        pawn = {
            ...
            account = 'cash',
            items = {
                [1] = { item = 'ls_coal_ore', price = math.random(15, 25), icon = 'hand-holding-dollar' },
                [2] = { item = 'ls_copper_ore', price = math.random(25, 50), icon = 'hand-holding-dollar' },
                [3] = { item = 'ls_iron_ore', price = math.random(50, 75), icon = 'hand-holding-dollar' },
                [4] = { item = 'ls_silver_ore', price = math.random(75, 100), icon = 'hand-holding-dollar' },
                [5] = { item = 'ls_gold_ore', price = math.random(100, 150), icon = 'hand-holding-dollar' },
                [6] = { item = 'ls_copper_ingot', price = math.random(150, 175), icon = 'hand-holding-dollar' },
                [7] = { item = 'ls_iron_ingot', price = math.random(175, 200), icon = 'hand-holding-dollar'},
                [8] = { item = 'ls_silver_ingot', price = math.random(200, 225), icon = 'hand-holding-dollar' },
                [9] = { item = 'ls_gold_ingot', price = math.random(225, 250), icon = 'hand-holding-dollar' },
            }
        },
        blip = {
