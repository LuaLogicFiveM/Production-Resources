...
Config.TuningMenu = {
    ...
    ["visual"] = {
        ...
        options = {
            ...
            {label = 'Neons', icon = 'neons.webp', modType = 'neonColor', type = 'colorpicker', tax = 'tuning', price = 1000},
    ...
    ["body"] = {
        ...
        onReturnOpen = 'visual',
        options = {
            {label = 'Spoilers', icon = 'spoiler.webp', modType = 0, tax = 'tuning', priceMultiplier = 0.1, cameraPointDirection = 'rear', cameraPointOffset = vec(0.0, 0.5, 0.5), cameraDirection = 'rear-left', cameraOffset = vec(0.3, -1.65, 1.3)},
            {label = 'Front Bumper', icon = 'front-bumper.webp', modType = 1, tax = 'tuning', priceMultiplier = 0.1, cameraPointDirection = 'front', cameraPointOffset = vec(0.0, -0.5, 0.2), cameraDirection = 'front-right', cameraOffset = vec(0.3, 1.65, 0.5)},
            {label = 'Rear Bumper', icon = 'rear-bumper.webp', modType = 2, tax = 'tuning', priceMultiplier = 0.1, cameraPointDirection = 'rear', cameraPointOffset = vec(0.0, 0.5, 0.2), cameraDirection = 'rear-left', cameraOffset = vec(0.3, -1.65, 0.5)},
            {label = 'Side Skirts', icon = 'side-skirts.webp', modType = 3, tax = 'tuning', priceMultiplier = 0.1, cameraOnBone = 'door_dside_f', cameraOffset = {-2.0, 2.25, 0.2}},
            {label = 'Exhaust', icon = 'exhaust.webp', modType = 4, tax = 'tuning', priceMultiplier = 0.1, cameraOnBone = 'exhaust', cameraOffset = {-1.55, -3.25, 0.2}},
            {label = 'Cage', icon = 'cage.webp', modType = 5, tax = 'tuning', priceMultiplier = 0.1, cameraOnBone = 'window_lf', cameraOffset = {-0.25, 3.5, 1.3}},
            {label = 'Grille', icon = 'grill.webp', modType = 6, tax = 'tuning', priceMultiplier = 0.1, cameraOnBone = 'bumper_f', cameraOffset = {0.25, 4.0, 0.65}},
            {label = 'Hood', icon = 'hood.webp', modType = 7, tax = 'tuning', priceMultiplier = 0.1, cameraOnBone = 'bonnet', cameraOffset = {-0.75, 4.0, 1.25}},
            {label = 'Left Fender', icon = 'left-fender.webp', modType = 8, tax = 'tuning', priceMultiplier = 0.05},
            {label = 'Right Fender', icon = 'right-fender.webp', modType = 9, tax = 'tuning', priceMultiplier = 0.05},
            {label = 'Roof', icon = 'roof.webp', modType = 10, tax = 'tuning', priceMultiplier = 0.05, cameraPointDirection = 'front', cameraPointOffset = vec(0.0, -0.85, 1.0), cameraDirection = 'front-right', cameraOffset = vec(0.9, 1.65, 1.65)},
            {label = 'TrimA', icon = 'other.webp', modType = 27, tax = 'tuning', priceMultiplier = 0.08},
            {label = 'APlate', icon = 'other.webp', modType = 35, tax = 'tuning', priceMultiplier = 0.02},
            {label = 'Speakers', icon = 'speakers.webp', modType = 36, tax = 'tuning', priceMultiplier = 0.15},
            {label = 'Trunk', icon = 'trunk.webp', modType = 37, tax = 'tuning', priceMultiplier = 0.09, openDoors = {5}, cameraOnBone = 'bumper_r', cameraOffset = {-0.85, -2.95, 0.785}},
    ...
    ["wheels"] = {
        ...
        options = {
            ...
            {label = 'Smoke Color', icon = 'wheel_smoke.webp', modType = 'tyreSmokeColor', type = 'colorpicker', tax = 'tuning', price = 500},
            {label = 'Wheels Stance', icon = 'wheels_stance.webp', modType = 'wheelsStance', type = 'wheelsstance', tax = 'tuning', price = 2500, dependence = Config.UseStanceSystem},
            {label = 'Wheels Size', icon = 'wheels_size.webp', modType = 'wheelSize', type = 'wheelsize', tax = 'tuning', price = 2500, dependence = Config.UseWheelsSize},
            {label = 'Wheels Width', icon = 'wheels_width.webp', modType = 'wheelWidth', type = 'wheelwidth', tax = 'tuning', price = 2500, dependence = Config.UseWheelsWidth},
    ...
    ["licenseplate"] = {
        ...
        onReturnOpen = 'visual',
        options = {
            {label = 'Change Numbers', modType = 'customPlateNumbers', type = 'customlicenseplate', tax = 'tuning', price = 1000000},
