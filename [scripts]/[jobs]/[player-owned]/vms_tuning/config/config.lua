...
Config.TuningPoints = {
         ['mlo013/1079'] = { -- BennyS: Interior Benny'S.
    ...
    points = { --# Points where you can tune vehicles
        [1] = vector3(-763.3046, 5885.5146, 15.8444),
    ...
    ['camel'] = { -- BennyS: Interior Benny'S.
        ...
        markerBossMenu = {
            enabled = true,
            id = 29,
            coords = vector3(-2028.9974, -505.9887, 12.2130),
            size = vec(0.55, 0.55, 0.55),
            color = {r=87, g=60, b=250, a=125},
            rotate = true,
            distanceToSee = 15.0,
        ...
        points = { --# Points where you can tune vehicles
            [1] = vector3(-2061.5737, -471.3734, 11.1860),
            -- [2] = vector3(-223.26, -1323.21, 29.89),
            -- [3] = vector(0.0, 0.0, 0.0),
        },
        jobGradesToSet = {
            {grade = 0, label = 'Employee'},
            {grade = 1, label = 'Driver'},
            {grade = 2, label = 'Lead Driver'},
            {grade = 3, label = 'Manager', needToBeBoss = true}, -- needToBeBoss means that only the boss can give this grade, the manager will not be able to do so
            {grade = 4, label = 'Boss', needToBeBoss = true}, -- needToBeBoss means that only the boss can give this grade, the manager will not be able to do so
        },
        ...
        -- Job Configuration common errors: https://docs.vames-store.com/assets/vms_tuning/common-errors#i-dont-see-tuning-points
        job = 'camel', -- job name - not required if you want to use this public removing this line.
        grades_access = nil, -- nil: for every user with job, string: 'name', table: {'name', 'name2'}
        manager_grades = 'manager', -- string: 'name', table: {'name', 'name2'}
        boss_grades = 'boss', -- string: 'name', table: {'name', 'name2'}
        cityhall_grades = { -- Grades for sections from vms_cityhall
