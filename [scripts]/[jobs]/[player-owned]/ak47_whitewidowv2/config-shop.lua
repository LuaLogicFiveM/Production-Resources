...
Config.BossActions = vector3(-934.1, -1168.34, -444.6)    --Boss action menu location. esx_society required

Config.Shop = {
    blip = {enable = false, pos = vector3(-1723.7836, -1112.7281, 13.2413), name = 'Cookies', sprite = 89, color = 3, size = 0.8, radius = 0.0, radius_color = 4},                                                           -- job name
    management = vector3(-1723.7836, -1112.7281, 13.2413),
    sell_coords = {                                         -- The coordinates where customes will buy things on this store (coordinates composed of x, y, z)
        vector3(-1722.8660, -1115.3015, 13.2226),
        vector3(-1721.1791, -1113.2307, 13.2411),
    },
    data = {
