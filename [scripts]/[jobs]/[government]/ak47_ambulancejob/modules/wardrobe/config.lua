Config.ClothingScript = 'illenium-appearance' --Auto detect or ['ak47_clothing', 'esx_skin', 'raid_clothes', 'rcore_clothes', 'illenium-appearance', 'codem-apperance', 'onex-creation']
