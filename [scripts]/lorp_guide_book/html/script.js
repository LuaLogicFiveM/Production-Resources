...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function closeBook() {
        ...
        setTimeout(() => {
            ...
            handleSearch('');
            switchToViewMode();
            fetch(`https://lorp_guide_book/closeBook`, { method: 'POST' });
        }, 300);
    }
    ...
    function saveContent() {
        ...
        fetch(`https://lorp_guide_book/savePage`, {
    ...
    function confirmAddCategory() {
        ...
        if (categoryName && categoryName.trim() !== "") {
            fetch(`https://lorp_guide_book/addCategory`, {
    ...
    function confirmRemoveCategory() {
        ...
        fetch(`https://lorp_guide_book/removeCategory`, {
    ...
    window.addEventListener('message', function(event) {
        ...
        if (data.action === 'openBook') {
            ...
            if (bookPages.length > 0) {
                ...
                document.getElementById('content-title-view').innerText = "Blank Book";
                document.getElementById('content-body-view').innerHTML = "<p>This book is currently empty. Admins can add new categories in edit mode.</p>";
                activeCategory = null;
                removeCategoryButton.disabled = true;
            }
    ...
    removeCategoryButton.addEventListener('click', () => {
        ...
        if (removeConfirmText) {
            removeConfirmText.innerText = `Are you sure you want to delete the category "${currentPage.category}"? This action cannot be undone.`;
        }
