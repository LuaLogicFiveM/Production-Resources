...
Config.custom_scripts_compatibility = {
	...
	['keys'] = "wasabi_carlock",						-- [qs-vehiclekeys|cd_garage|jaksam|wasabi_carlock|MrNewbVehicleKeys|tgiann-hotwire|Renewed|okokGarage|default|other] Keys script Compatibility
	['mdt'] = "lb-tablet",						-- [ps-mdt|redutzu-mdt|lb-tablet|default|other] MDT script Compatibility (to log weapon serial)
...
Config.notification = {							-- (Only if notification is default)
	['has_title'] = true,						-- Select if you want the notification to have a title or not
	['position'] = "top",					-- [top-left|top-center|top-right|middle-left|middle-right|bottom-left|bottom-center|bottom-right] Position of the notification on the screen
	['duration'] = 5000,						-- Time (in ms) the notifications will be shown
}
