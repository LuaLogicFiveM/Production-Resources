...
config.Fuel = "auto"  -- auto | ox_fuel | qb-fuel | ps-fuel | qs-fuelstations | legacyfuel | renewed-fuel | ti_fuel | lc_fuel | x-fuel | cdn-fuel | esx-sna-fuel | bigdaddy-fuel | okokgasstation | rcore_fuel
