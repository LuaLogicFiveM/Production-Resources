...
Config.ShelvesProducts = {
    ...
    ['Attachments'] = {
        ['at_box_drum']        = { name = 'at_box_drum',        label = 'Round Box Drum',        price = 50000, tax = 'products.Attachments' },
        ['at_clear_drum']      = { name = 'at_clear_drum',      label = 'Clear Drum',            price = 50000, tax = 'products.Attachments' },
        ['at_clear_extended']  = { name = 'at_clear_extended',  label = 'Clear Extended Clip',   price = 50000, tax = 'products.gattachmentsuns' },
        ['at_kriss_mag']       = { name = 'at_kriss_mag',       label = 'Kriss Magazine',         price = 50000, tax = 'products.Attachments' },
        ['at_flashlight']      = { name = 'at_flashlight',      label = 'Flashlight',             price = 30000, tax = 'products.Attachments' },
        ['at_laser']           = { name = 'at_laser',           label = 'Laser',                  price = 30000, tax = 'products.Attachments' },
        ['at_optic']           = { name = 'at_optic',           label = 'Optic',                  price = 20000, tax = 'products.Attachments' },
        ['at_grip']            = { name = 'at_grip',            label = 'Grip',                   price = 28500, tax = 'products.Attachments' },
        ['at_suppressor']      = { name = 'at_suppressor',      label = 'Suppressor',             price = 75000, tax = 'products.Attachments' },
        ['at_magazine']        = { name = 'at_magazine',        label = 'Extended Magazine',      price = 40000, tax = 'products.Attachments' },
    },
