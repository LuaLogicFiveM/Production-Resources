...
RegisterCallback('lorp_banking:getPlayerData', function(source, cb)
...
RegisterCallback('lorp_banking:getTransactionHistory', function(source, cb)
    local xPlayer = GetPlayer(source)
...
RegisterCallback('lorp_banking:getBalanceHistory', function(source, cb)
    local xPlayer = GetPlayer(source)
    if not xPlayer then return cb({}) end
...
RegisterServerEvent('lorp_banking:deposit')
AddEventHandler('lorp_banking:deposit', function(amount)
    local source = source
    local xPlayer = GetPlayer(source)
    ...
    local cashMoney = GetPlayerCash(source)
...
RegisterServerEvent('lorp_banking:withdraw')
AddEventHandler('lorp_banking:withdraw', function(amount)
    local source = source
    local xPlayer = GetPlayer(source)
...
RegisterServerEvent('lorp_banking:transfer')
AddEventHandler('lorp_banking:transfer', function(targetId, amount, description)
    local source = source
    local xPlayer = GetPlayer(source)
...
RegisterServerEvent('lorp_banking:openSavingsAccount')
AddEventHandler('lorp_banking:openSavingsAccount', function()
    local source = source
    local xPlayer = GetPlayer(source)
...
RegisterServerEvent('lorp_banking:depositSavings')
AddEventHandler('lorp_banking:depositSavings', function(amount)
    local source = source
    local xPlayer = GetPlayer(source)
...
RegisterServerEvent('lorp_banking:withdrawSavings')
AddEventHandler('lorp_banking:withdrawSavings', function(amount)
    local source = source
    local xPlayer = GetPlayer(source)
...
RegisterServerEvent('lorp_banking:transferBetweenAccounts')
AddEventHandler('lorp_banking:transferBetweenAccounts', function(fromAccount, toAccount, amount)
    local source = source
    local xPlayer = GetPlayer(source)
...
RegisterServerEvent('lorp_banking:closeSavingsAccount')
AddEventHandler('lorp_banking:closeSavingsAccount', function()
    local source = source
    local xPlayer = GetPlayer(source)
    ...
    MySQL.Async.fetchAll('SELECT balance, status FROM banking_savings WHERE identifier = @identifier', {
        ...
        MySQL.Async.execute('UPDATE banking_savings SET status = @status, balance = @balance WHERE identifier = @identifier', {
            ...
            if rowsChanged > 0 then
                ...
                TriggerClientEvent('lorp_banking:savingsAccountClosed', source)
            else
...
RegisterServerEvent('lorp_banking:openUI')
AddEventHandler('lorp_banking:openUI', function()
    local source = source
    TriggerClientEvent('lorp_banking:openUI', source)
end)

RegisterServerEvent('lorp_banking:setupPin')
AddEventHandler('lorp_banking:setupPin', function(pin)
    local source = source
    local xPlayer = GetPlayer(source)
        ...
        if existingPin then
            ...
            MySQL.Async.execute('UPDATE banking_pins SET pin = @pin WHERE identifier = @identifier', {
                ...
                if rowsChanged > 0 then
                    ...
                    TriggerClientEvent('lorp_banking:pinSetupSuccess', source, { pin = pin })
...
RegisterCallback('lorp_banking:verifyPin', function(source, cb, enteredPin)
    local xPlayer = GetPlayer(source)
...
RegisterServerEvent('lorp_banking:clearAllTransactions')
AddEventHandler('lorp_banking:clearAllTransactions', function()
    local source = source
    local xPlayer = GetPlayer(source)
...
-- Usage: exports['lorp_banking']:AddBankMoney(source, amount, description)
...
-- Usage: exports['lorp_banking']:RemoveBankMoney(source, amount, description)
...
-- Usage: exports['lorp_banking']:AddCashMoney(source, amount, description)
    ...
    SendDiscordLog('adminActions', '💵 Admin Cash Grant', 
        'An admin has given cash to a player.',
        {
            ...
            },
            {
                ...
                ["value"] = '$' .. FormatMoney(GetPlayerCash(source)),
                ["inline"] = true
            },
            {
                ["name"] = "Description",
...
-- Usage: exports['lorp_banking']:RemoveCashMoney(source, amount, description)
exports('RemoveCashMoney', function(source, amount, description)
    ...
    local currentCash = GetPlayerCash(source)
...
-- Usage: exports['lorp_banking']:GetPlayerAccount(source)
exports('GetPlayerAccount', function(source)
    ...
    local accountData = {
        ...
        cashBalance = GetPlayerCash(source),
        accountNumber = '****-****-' .. string.sub(identifier, -4)
    }
...
-- Usage: exports['lorp_banking']:GetBankBalance(source)
...
-- Usage: exports['lorp_banking']:GetCashBalance(source)
exports('GetCashBalance', function(source)
    ...
    return GetPlayerCash(source)
end)

-- Export: Transfer money between players
-- Usage: exports['lorp_banking']:TransferMoney(fromSource, toSource, amount, description)
...
-- Usage: exports['lorp_banking']:GetSavingsAccount(source, callback)
...
-- Usage: exports['lorp_banking']:AddSavingsMoney(source, amount, description)
...
-- Usage: exports['lorp_banking']:LogCustomTransaction(source, type, amount, description)
...
-- Usage: exports['lorp_banking']:OpenBankingUI(source)
...
-- Usage: exports['lorp_banking']:HasEnoughBank(source, amount)
...
-- Usage: exports['lorp_banking']:HasEnoughCash(source, amount)
exports('HasEnoughCash', function(source, amount)
    ...
    return GetPlayerCash(source) >= amount
end)
