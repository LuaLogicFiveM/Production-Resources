...
cfg.discord = {
    ...
    botToken = GetConvar('discord_token', ""),                --Bot need to be in the same discord as the guild ID below.
    guildId = GetConvar('discord_guild_id', ""),                  --ID of your discord server/guild.
