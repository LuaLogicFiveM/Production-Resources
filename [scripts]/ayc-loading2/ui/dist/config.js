window.appConfig = {
    ...
    background: {
        ...
        isVideoLocal: true, // Set to true if you are using local video file
        video: 'assets/video/video.mp4', // YouTube link or direct video link ending with compatible formats (.mp4 etc) or relative directory if local (assets/video/video.mp4)
    ...
    randomSong: false, // While true, the configured songs will be playing randomly and not in order
    ...
    announcements: { // You can add more or remove announcements. if you don't need it entirely, look at elements at line 101
        1: {
            ...
            title: 'Version v2.0.0', // The title of the announcement
