Config = {
    ...
    IT_MAIN_EVENT_RACE_MAX_BET = 50000, -- max. bet for the main event race
    ...
    IT_LOCAL_RACE_MAX_BET = 50000, -- max. bet for the local race
    ...
    IT_LOCAL_RACE_WIN_CHANCE = 20, -- win chance (from 0 to 100), def: 100, 100 means that it's not *unlucky* at all
    IT_MAIN_EVENT_RACE_WIN_CHANCE = 20, -- win chance (from 0 to 100), def: 100, 100 means that it's not *unlucky* at all
    ...
    DISABLE_IDLE_CAM = false, -- disable idle cam animations (looking around)
    ...
    PRICES_CURRENCY = "$", -- $, €, £, ¥, ₽, ₩, ₹ ...
    RADAR_ZOOMLEVEL = 1.0, -- customize the radar zoom, from 0.0 (closest) to higher
    ...
    SocietyFramework = Society.EsxAddonAccount,
    --[[
    ...
    -- Job
    BossGrade = 3, -- the max grade (boss) for the casino job
    BossName = "boss",
    ...
    UseNUIHUD = true, -- whether to use chips hud on NUI (you can customize it in 'html/index.html')
