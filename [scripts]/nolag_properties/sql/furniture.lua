...
FurnitureConfig.SellPercentage = 100 -- Percentage of the original price you get back when selling furniture
...
FurnitureConfig.Furniture = {
	addon = {
		...
		items = {
			-- Japa Pack
			{ object = 'skrill_terra_verde_paint', price = 0, label = 'Paint' },
			{ object = 'skrill_japa_pear_bowl', price = 0, label = 'Pear Bowl' },
			{ object = 'skrill_japa_chair', price = 0, label = 'Chair' },
			{ object = 'skrill_japa_table', price = 0, label = 'Table' },
			{ object = 'skrill_japa_plant', price = 0, label = 'Plant' },
			-- New
			{ object = 'skrill_april_f_easter_table', price = 0, label = 'Easter Table' },
			{ object = 'skrill_april_f_easter_chair', price = 0, label = 'Easter Chair' },
			{ object = 'skrill_april_f_easter_bunny', price = 0, label = 'Easter Bunny' },
			-- Old
			{ object = 'skrill_march_f_apple_bowl', price = 0, label = 'Apple Bowl' },
			{ object = 'skrill_march_f_vase', price = 0, label = 'Vase' },
			{ object = 'skrill_november_ginger', price = 0, label = 'Pet House' },
			{ object = 'skrill_november_pet_house', price = 0, label = 'Pet House B' },
			{ object = 'skrill_november_tree', price = 0, label = 'Pet House C' },
			{ object = 'skrill_october_mat', price = 0, label = 'Mat' },
			{ object = 'skrill_october_mat_b', price = 0, label = 'Mat B' },
			{ object = 'skrill_october_mat_c', price = 0, label = 'Mat C' },
			{ object = 'skrill_october_mat_d', price = 0, label = 'Mat D' },
			{ object = 'skrill_october_mat_e', price = 0, label = 'Mat E' },
			{ object = 'skrill_october_mat_f', price = 0, label = 'Mat F' },
			{ object = 'skrill_september_halloween_bench', price = 0, label = 'Bench' },
			{ object = 'skrill_september_halloween_bench_b', price = 0, label = 'Bench B' },
			{ object = 'skrill_september_halloween_cauldron', price = 0, label = 'Cauldron' },
			{ object = 'skrill_september_halloween_coffin', price = 0, label = 'Coffin' },
			{ object = 'skrill_september_halloween_pumpkin', price = 0, label = 'Pumpkin' },
			{ object = 'skrill_september_halloween_pumpkin_b', price = 0, label = 'Pumpkin B' },
			{ object = 'skrill_cloud_living_pet_bed', price = 0, label = 'Pet bed' },
			{ object = 'skrill_cloud_living_pet_bed_b', price = 0, label = 'Pet bed B' },
			{ object = 'skrill_cloud_living_plant', price = 0, label = 'Plant' },
			{ object = 'skrill_cloud_living_plant_b', price = 0, label = 'Plant B' },
			{ object = 'skrill_cloud_living_sofa', price = 0, label = 'Sofa' },
			{ object = 'skrill_cloud_living_sofa_b', price = 0, label = 'Sofa B' },
			{ object = 'skrill_cloud_living_sofa_c', price = 0, label = 'Sofa C' },
			{ object = 'skrill_cloud_living_table', price = 0, label = 'Table' },
			{ object = 'skrill_clound_living_incense', price = 0, label = 'Incense' },
			{ object = 'skrill_clound_living_incense_b', price = 0, label = 'Incense B' },
			{ object = 'skrill_clound_living_wall_decor', price = 0, label = 'Wall Decor' },
			{ object = 'skrill_clound_living_wall_decor_b', price = 0, label = 'Wall Decor B' },				
			{ object = 'skrill_july_bache_party_acc', price = 0, label = 'Bachelorette party' },
			{ object = 'skrill_july_bache_tulip', price = 0, label = 'Bachelorette tulip' },
			{ object = 'skrill_july_bache_shoes', price = 0, label = 'Bachelorette shoes' },
			{ object = 'skrill_july_bache_hat', price = 0, label = 'Bachelorette hat' },
			{ object = 'skrill_july_bache_dress', price = 0, label = 'Bachelorette dress' },
			{ object = 'skrill_july_bache_coffee', price = 0, label = 'Bachelorette coffee' },
			{ object = 'skrill_july_bache_balloons', price = 0, label = 'Bachelorette ballons' },
			{ object = 'skrill_july_bache_cake', price = 0, label = 'Bachelorette cake' },					
			{ object = 'skrill_june_beach_flipflops', price = 0, label = 'Flip-Flops' },
			{ object = 'skrill_june_beach_flipflops_b', price = 0, label = 'Flip-Flops B' },
			{ object = 'skrill_june_beach_hat', price = 0, label = 'Hat' },
			{ object = 'skrill_june_beach_ice_creams', price = 0, label = 'Ice Cream' },
			{ object = 'skrill_june_beach_lounger', price = 0, label = 'Lounger' },
			{ object = 'skrill_june_beach_lounger_b', price = 0, label = 'Lounger B' },
			{ object = 'skrill_june_beach_lounger_c', price = 0, label = 'Lounger C' },
			{ object = 'skrill_june_beach_lounger_d', price = 0, label = 'Lounger D' },
			{ object = 'skrill_june_beach_parasol', price = 0, label = 'Parasol' },
			{ object = 'skrill_june_beach_parasol_b', price = 0, label = 'Parasol B' },
			{ object = 'skrill_june_beach_parasol_c', price = 0, label = 'Parasol C' },
			{ object = 'skrill_june_beach_parasol_d', price = 0, label = 'Parasol D' },
			{ object = 'skrill_barbecue_party_asparagus_and_limes', price = 0, label = 'Asparagus and Limes' },
			{ object = 'skrill_barbecue_party_burger_plate', price = 0, label = 'Burger Plate' },
			{ object = 'skrill_barbecue_party_chicken', price = 0, label = 'Chicken' },
			{ object = 'skrill_barbecue_party_corn', price = 0, label = 'Corn' },
			{ object = 'skrill_barbecue_party_dining_chair', price = 0, label = 'Dining Chair' },
			{ object = 'skrill_barbecue_party_dining_chair_b', price = 0, label = 'Dining Chair B' },
			{ object = 'skrill_barbecue_party_dining_chair_c', price = 0, label = 'Dining Chair C' },
			{ object = 'skrill_barbecue_party_dining_plate', price = 0, label = 'Dining Plate' },
			{ object = 'skrill_barbecue_party_dining_plate_b', price = 0, label = 'Dining Plate B' },
			{ object = 'skrill_barbecue_party_fast_food_plate', price = 0, label = 'Fast Food Plate' },
			{ object = 'skrill_barbecue_party_kitchen_counter', price = 0, label = 'Kitchen Counter' },
			{ object = 'skrill_barbecue_party_kitchen_grill', price = 0, label = 'Kitchen Grill' },
			{ object = 'skrill_barbecue_party_kitchen_grill_b', price = 0, label = 'Kitchen Grill B' },
			{ object = 'skrill_barbecue_party_kitchen_grill_open_version', price = 0, label = 'Kitchen Grill Open Version' },
			{ object = 'skrill_barbecue_party_kitchen_grill_open_version_b', price = 0, label = 'Kitchen Grill Open Version B' },
			{ object = 'skrill_barbecue_party_kitchen_island', price = 0, label = 'Kitchen Island' },
			{ object = 'skrill_barbecue_party_kitchen_salmon', price = 0, label = 'Kitchen Salmon' },
			{ object = 'skrill_barbecue_party_kitchen_steak_rose_mary', price = 0, label = 'Kitchen Steak Rose Mary' },
			{ object = 'skrill_barbecue_party_mini_fridge_closed', price = 0, label = 'Mini Fridge Closed' },
			{ object = 'skrill_barbecue_party_mini_fridge_closed_b', price = 0, label = 'Mini Fridge Closed B' },
			{ object = 'skrill_barbecue_party_mini_fridge_open', price = 0, label = 'Mini Fridge Open' },
			{ object = 'skrill_barbecue_party_mini_fridge_open_b', price = 0, label = 'Mini Fridge Open B' },
			{ object = 'skrill_barbecue_party_outdoor_for_mini_fridge', price = 0, label = 'Outdoor for Mini Fridge' },
			{ object = 'skrill_barbecue_party_portable_pizza_oven', price = 0, label = 'Portable Pizza Oven' },
			{ object = 'skrill_barbecue_party_portable_pizza_oven_b', price = 0, label = 'Portable Pizza Oven B' },
			{ object = 'skrill_barbecue_party_portable_pizza_oven_c', price = 0, label = 'Portable Pizza Oven C' },
			{ object = 'skrill_barbecue_party_portable_pizza_oven_d', price = 0, label = 'Portable Pizza Oven D' },
			{ object = 'skrill_barbecue_party_skewer', price = 0, label = 'Skewer' },
			{ object = 'skrill_barbecue_party_storage_box', price = 0, label = 'Storage Box' },
			{ object = 'skrill_barbecue_party_table', price = 0, label = 'Table' },
			-- April
			{ object = 'skrill_feast_cake', price = 0, label = 'Cake' },
			{ object = 'skrill_feast_chocolate_cherry_tart', price = 0, label = 'Chocolate Cherry Tart' },
			{ object = 'skrill_feast_cranberry_sauce', price = 0, label = 'Cranberry Sauce' },
			{ object = 'skrill_feast_dinner_rolls', price = 0, label = 'Dinner Rolls' },
			{ object = 'skrill_feast_gravy_boat', price = 0, label = 'Gravy Boat' },
			{ object = 'skrill_feast_green_beans', price = 0, label = 'Green Beans' },
			{ object = 'skrill_feast_mashed_potatoes', price = 0, label = 'Mashed Potatoes' },
			{ object = 'skrill_feast_plate', price = 0, label = 'Plate' },
			{ object = 'skrill_feast_platter', price = 0, label = 'Platter' },
			{ object = 'skrill_feast_stuffing', price = 0, label = 'Stuffing' },
			{ object = 'skrill_feast_turkey', price = 0, label = 'Turkey' },
			-- March 
			{ object = 'skrill_cakes_you_suck', price = 0, label = 'Cake' },
			{ object = 'skrill_cakes_toxic', price = 0, label = 'Cake B' },
			{ object = 'skrill_cakes_sorry_i_spit_in_your_burrito', price = 0, label = 'Cake C ' },
			{ object = 'skrill_cakes_sorry_i_fckud_your_dad', price = 0, label = 'Cake D' },
			{ object = 'skrill_cakes_sorry_i_smoke_all_your_weed', price = 0, label = 'Cake E' },
			{ object = 'skrill_cakes_sorry_i_banged_your_mom', price = 0, label = 'Cake F' },
			{ object = 'skrill_cakes_happy_b_day_slut', price = 0, label = 'Cake G' },
			{ object = 'skrill_cakes_congrats_on_your_massive_pnis', price = 0, label = 'Cake H' },
			-- February
			{ object = 'skrill_february_box_content', price = 0, label = 'February Box Content' },
			{ object = 'skrill_february_letter_supplies', price = 0, label = 'February Letter Supplies' },
			{ object = 'skrill_st_valentin_cake', price = 0, label = 'Valentin Cake' },
			{ object = 'skrill_st_valentin_cake_b', price = 0, label = 'Valentin Cake B' },
			{ object = 'skrill_st_valentin_candy', price = 0, label = 'Valentin Candy' },
			{ object = 'skrill_st_valentin_candy_b', price = 0, label = 'Valentin Candy B' },
			{ object = 'skrill_st_valentin_closed_box', price = 0, label = 'Valentin Closed Box' },
			{ object = 'skrill_st_valentin_dress', price = 0, label = 'Valentin Dress' },
			{ object = 'skrill_st_valentin_first_met_and_kiss', price = 0, label = 'Valentin First Met and Kiss' },
			{ object = 'skrill_st_valentin_galentine', price = 0, label = 'Valentin Galentine' },
			{ object = 'skrill_st_valentin_key_from_my_heart', price = 0, label = 'Valentin Key from My Heart' },
			{ object = 'skrill_st_valentin_love_balloon', price = 0, label = 'Valentin Love Balloon' },
			{ object = 'skrill_st_valentin_photo', price = 0, label = 'Valentin Photo' },
			{ object = 'skrill_st_valentin_rose', price = 0, label = 'Valentin Rose' },
			{ object = 'skrill_st_valentin_rose_two', price = 0, label = 'Valentin Rose Two' },
			{ object = 'skrill_st_valentin_round_balloon', price = 0, label = 'Valentin Round Balloon' },
			{ object = 'skrill_st_valentin_shoppingbag', price = 0, label = 'Valentin Shoppingbag' },
			{ object = 'skrill_st_valentin_table', price = 0, label = 'Valentin Table' },
			{ object = 'skrill_st_valentin_wardrobe', price = 0, label = 'Valentin Wardrobe' },
			{ object = 'skrill_st_valentin_xoxo', price = 0, label = 'Valentin Xoxo' }	,
			-- January
			{ object = 'skrill_january_bandaid', price = 0, label = 'Bandaid' },
			{ object = 'skrill_january_bandaid_b', price = 0, label = 'Bandaid B' },
			{ object = 'skrill_january_bandaid_c', price = 0, label = 'Bandaid C' },
			{ object = 'skrill_january_blood_pressure_monitor', price = 0, label = 'Blood Pressure Monitor' },
			{ object = 'skrill_january_blood_pressure_monitor_b', price = 0, label = 'Blood Pressure Monitor B' },
			{ object = 'skrill_january_blood_pressure_monitor_c', price = 0, label = 'Blood Pressure Monitor C' },
			{ object = 'skrill_january_hanging_doctor_uniform', price = 0, label = 'Hanging Doctor Uniform' },
			{ object = 'skrill_january_hanging_doctor_uniform_b', price = 0, label = 'Hanging Doctor Uniform B' },
			{ object = 'skrill_january_hanging_doctor_uniform_c', price = 0, label = 'Hanging Doctor Uniform C' },
			{ object = 'skrill_january_magical_pills', price = 0, label = 'Magical Pills' },
			{ object = 'skrill_january_magical_pills_b', price = 0, label = 'Magical Pills B' },
			{ object = 'skrill_january_magical_pills_version_two', price = 0, label = 'Magical Pills Version Two' },
			{ object = 'skrill_january_magical_pills_version_two_b', price = 0, label = 'Magical Pills Version Two B' },
			{ object = 'skrill_january_serum_infusion', price = 0, label = 'Serum Infusion' },
			{ object = 'skrill_january_serum_infusion_b', price = 0, label = 'Serum Infusion B' },
			{ object = 'skrill_january_serum_infusion_c', price = 0, label = 'Serum Infusion C' },
			{ object = 'skrill_january_stethoscope', price = 0, label = 'Stethoscope' },
			{ object = 'skrill_january_stethoscope_b', price = 0, label = 'Stethoscope B' },
			{ object = 'skrill_january_stethoscope_c', price = 0, label = 'Stethoscope C' },
			{ object = 'skrill_january_trash', price = 0, label = 'Trash' },
			{ object = 'skrill_january_trash_b', price = 0, label = 'Trash B' },
			{ object = 'skrill_january_trash_c', price = 0, label = 'Trash C' },
			{ object = 'skrill_december_cake', price = 5, label = 'Cake' },
			{ object = 'skrill_december_gingerbread', price = 5, label = 'Gingerbread' },
			{ object = 'skrill_december_pet_bed', price = 5, label = 'Pet bed' },
			{ object = 'skrill_december_pet_bed_b', price = 5, label = 'Pet bed b' },
			{ object = 'skrill_sign_merry_christmas', price = 5, label = 'Sign Merry Christmas' },
			{ object = 'skrill_campers_bag', price = 5, label = 'Bag' },
			{ object = 'skrill_campers_bag_b', price = 5, label = 'Bag B' },
			{ object = 'skrill_campers_bag_c', price = 5, label = 'Bag C' },
			{ object = 'skrill_campers_chair', price = 5, label = 'Chair' },
			{ object = 'skrill_campers_chair_b', price = 5, label = 'Chair B' },
			{ object = 'skrill_campers_chair_c', price = 5, label = 'Chair C' },
			{ object = 'skrill_campers_chair_d', price = 20, label = 'Bath robe C' },
			{ object = 'skrill_campers_clean', price = 20, label = 'Clean'},
			{ object = 'skrill_campers_cooler', price = 5, label = 'Cooler' },
			{ object = 'skrill_campers_cooler_b', price = 5, label = 'Cooler B' },
			{ object = 'skrill_campers_cooler_c', price = 4, label = 'Cooler C' },
			{ object = 'skrill_campers_firepit', price = 7, label = 'Firepit' },
			{ object = 'skrill_campers_firepit_b', price = 20, label = 'Firepit B' },
			{ object = 'skrill_campers_mug', price = 5, label = 'Mug' },
			{ object = 'skrill_campers_mug_b', price = 5, label = 'Mug B' },
			{ object = 'skrill_campers_mug_c', price = 5, label = 'Mug C' },
			{ object = 'skrill_campers_portable_grill', price = 5, label = 'Portable Grill' },
			{ object = 'skrill_campers_pot', price = 5, label = 'Pot' },
			{ object = 'skrill_campers_propane', price = 5, label = 'Propane' },
			{ object = 'skrill_campers_sausages', price = 5, label = 'Sausages' },
			{ object = 'skrill_campers_shelf', price = 5, label = 'Shelf' },
			{ object = 'skrill_halloween_evil_pumpkin', price = 5, label = 'Evil pumpkin' },
			{ object = 'skrill_halloween_evil_pumpkin_small', price = 5, label = 'Evil pumpkin B' },
			{ object = 'skrill_halloween_happy_pumpkin', price = 5, label = 'Happy pumpkin' },
			{ object = 'skrill_halloween_happy_pumpkin_small', price = 5, label = 'Happy pumpkin B' },
			{ object = 'skrill_bathroom_bathrobe', price = 5, label = 'Bath robe' },
			{ object = 'skrill_bathroom_bathrobe_b', price = 5, label = 'Bath robe B' },
			{ object = 'skrill_bathroom_bathrobe_c', price = 20, label = 'Bath robe C' },
			{ object = 'skrill_bathroom_bathrobe_d', price = 20, label = 'Bath robe D'},
			{ object = 'skrill_bathroom_bathtub', price = 5, label = 'Bathtub' },
			{ object = 'skrill_bathroom_bathtub_b', price = 5, label = 'Bathtub B' },
			{ object = 'skrill_bathroom_double_sink_vanity', price = 4, label = 'Sink vanity' },
			{ object = 'skrill_bathroom_double_sink_vanity_b', price = 7, label = 'Sink vanity B' },
			{ object = 'skrill_bathroom_double_sink_vanity_c', price = 20, label = 'Sink vanity C' },
			{ object = 'skrill_bathroom_double_sink_vanity_d', price = 5, label = 'Sink vanity D' },
			{ object = 'skrill_bathroom_mirror_black', price = 5, label = 'Mirror Black' },
			{ object = 'skrill_bathroom_mirror_black_b', price = 5, label = 'Mirror Black B' },
			{ object = 'skrill_bathroom_mirror_black_c', price = 5, label = 'Mirror Black C' },
			{ object = 'skrill_bathroom_mirror_black_d', price = 5, label = 'Mirror Black D' },
			{ object = 'skrill_bathroom_mirror_or', price = 5, label = 'Mirror Or' },
			{ object = 'skrill_bathroom_mirror_or_b', price = 5, label = 'Mirror Or B' },
			{ object = 'skrill_bathroom_mirror_or_c', price = 5, label = 'Mirror Or c' },
			{ object = 'skrill_bathroom_mirror_or_d', price = 5, label = 'Mirror Or d' },
			{ object = 'skrill_bathroom_saop_dispenser', price = 5, label = 'Saop dispenser' },
			{ object = 'skrill_bathroom_saop_dispenser_b', price = 5, label = 'Saop dispenser B' },
			{ object = 'skrill_bathroom_saop_dispenser_c', price = 5, label = 'Saop dispenser C' },
			{ object = 'skrill_bathroom_saop_dispenser_d', price = 20, label = 'Saop dispenser D' },
			{ object = 'skrill_bathroom_saop_dispenser_e', price = 20, label = 'Saop dispenser E' },
			{ object = 'skrill_bathroom_saop_dispenser_f', price = 5, label = 'Saop dispenser F' },
			{ object = 'skrill_bathroom_sink', price = 5, label = 'Sink' },
			{ object = 'skrill_bathroom_sink_b', price = 4, label = 'Sink B' },
			{ object = 'skrill_bathroom_soap_jar', price = 7, label = 'Soap jar' },
			{ object = 'skrill_bathroom_toilet_paper', price = 20, label = 'Toilet paper' },
			{ object = 'skrill_bathroom_toilet_paper_b', price = 5, label = 'Toilet paper B' },
			{ object = 'skrill_bathroom_toilet_paper_c', price = 5, label = 'Toilet paper C' },
			{ object = 'skrill_bathroom_toothbrush_set', price = 5, label = 'Tooth brush' },
			{ object = 'skrill_bathroom_toothbrush_set_b', price = 5, label = 'Tooth brush B' },
			{ object = 'skrill_bathroom_toothbrush_set_c', price = 5, label = 'Tooth brush C' },
			{ object = 'skrill_bathroom_toothbrush_set_d', price = 5, label = 'Tooth brush D' },
			{ object = 'skrill_bathroom_towels', price = 5, label = 'Towels'},
			{ object = 'skrill_bathroom_towels_b', price = 5, label = 'Towels B' },
			{ object = 'skrill_cotton_swab_container', price = 5, label = 'Cotton Swab Container' },
			{ object = 'skrill_cotton_swab_container_b', price = 5, label = 'Cotton Swab Container B'},
			{ object = 'skrill_cotton_swab_container_c', price = 5, label = 'Cotton Swab Container C' },
			{ object = 'skrill_bathroom_towel_rack', price = 5, label = 'Towel Rack' },
			{ object = 'skrill_bathroom_towel_rack_b', price = 5, label = 'Towel Rack B' },
			{ object = 'skrill_bathroom_tray', price = 5, label = 'Tray' },
			{ object = 'skrill_bathroom_tray_b', price = 5, label = 'Tray B' },
			{ object = 'skrill_bathroom__towel_heater', price = 5, label = 'Towel Heater' },
			{ object = 'skrill_bathroom__towel_heater_b', price = 5, label = 'Towel Heater B' },
			{ object = 'skrill_bathroom__towel_heater_c', price = 5, label = 'Towel Heater C' },
			{ object = 'skrill_cottage_redm_tarot_card', price = 5, label = 'Tarot card' },
			{ object = 'skrill_cottage_redm_sausage', price = 5, label = 'Sausage' },
			{ object = 'skrill_cottage_redm_rosy_milk_jug_b', price = 20, label = 'Milk' },
			{ object = 'skrill_cottage_redm_rosy_milk_jug', price = 20, label = 'Milk B' },
			{ object = 'skrill_cottage_redm_milk_tea_b', price = 5, label = 'Tea' },
			{ object = 'skrill_cottage_redm_milk_tea', price = 5, label = 'Tea B' },
			{ object = 'skrill_cottage_redm_lamp_deco', price = 4, label = 'Lamp deco' },
			{ object = 'skrill_cottage_redm_kettle_b', price = 7, label = 'Kettle' },
			{ object = 'skrill_cottage_redm_kettle', price = 20, label = 'Kettle B' },
			{ object = 'skrill_cottage_redm_carrot', price = 5, label = 'Carrot' },
			{ object = 'skrill_cottage_redm_card', price = 5, label = 'Card' },
			{ object = 'skrill_cottage_redm_book', price = 5, label = 'Book' },
			{ object = 'skrill_cottage_redm_book_b', price = 5, label = 'Book B' },
			{ object = 'atr_poster_phone', price = 5, label = 'Poster' },
			{ object = 'atr_poster_w', price = 5, label = 'Poster B' },
			{ object = 'atr_poster_r', price = 20, label = 'Poster C' },
			{ object = 'atr_poster_b', price = 20, label = 'Poster D' },
			{ object = 'atr_poster_a', price = 5, label = 'Poster E' },
			{ object = 'atr_poster_y', price = 5, label = 'Poster F' },
			{ object = 'atr_poster_s', price = 4, label = 'Poster G' },
			{ object = 'atr_poster_ma', price = 7, label = 'Poster H' },
			{ object = 'atr_poster_g', price = 20, label = 'Poster I' },
			{ object = 'atr_poster_m', price = 5, label = 'Poster J' },
			{ object = 'atr_poster_nicki_minaj', price = 5, label = 'Poster K' },
			{ object = 'bamboo-star', price = 20, label = 'Chair' },
			{ object = 'bamboo-star_b', price = 20, label = 'Chair B' },
			{ object = 'bamboo-star_c', price = 5, label = 'Chair C' },
			{ object = 'books-magazine-decor', price = 5, label = 'Magazine decor' },
			{ object = 'deco-paints', price = 4, label = 'ART' },
			{ object = 'deco-paints_b', price = 7, label = 'ART B' },
			{ object = 'deco-paints_c', price = 20, label = 'ART C' },
			{ object = 'filikka-console', price = 5, label = 'Consol' },
			{ object = 'filikka-console_b', price = 5, label = 'Consol B' },
			{ object = 'atr_booster_tablet', price = 20, label = 'Tablet' },
			{ object = 'atr_booster_tablet_b', price = 20, label = 'Tablet B' },
			{ object = 'atr_booster_tablet_c', price = 5, label = 'Tablet C' },
			{ object = 'atr_booster_tablet_d', price = 5, label = 'Tablet D' },
			{ object = 'atr_set_drinks_bacardi', price = 4, label = 'Bacardi' },
			{ object = 'atr_set_drinks_barefoot_bubbly', price = 7, label = 'Bacardi Bubbly' },
			{ object = 'atr_set_drinks_casa_del_sol', price = 20, label = 'Casa Del Sol' },
			{ object = 'set_drinks_casamigos', price = 5, label = 'Casamigos' },
			{ object = 'set_drinks_casamigos_b', price = 5, label = 'Casamigos B' },
			{ object = 'set_drinks_casamigos_c', price = 5, label = 'Casamigos C' },
			{ object = 'set_drinks_casamigos_d', price = 5, label = 'Casamigos D' },
			{ object = 'atr_set_drinks_ciroc_passion', price = 20, label = 'Ciroc passion' },
			{ object = 'atr_set_drinks_ciroc_pomeranate', price = 5, label = 'Ciroc pomeranate' },
			{ object = 'atr_set_drinks_ciroc_summer', price = 5, label = 'Ciroc summer' },
			{ object = 'atr_set_drinks_crown', price = 4, label = 'Crown' },
			{ object = 'atr_set_drinks_don_julio', price = 7, label = 'Don julio' },
			{ object = 'atr_set_drinks_dusse', price = 20, label = 'Dusse' },
			{ object = 'set_drinks_everclear', price = 5, label = 'Everclear' },
			{ object = 'atr_set_drinks_hennessy_black', price = 5, label = 'Hennessy black' },
			{ object = 'atr_set_drinks_hennessy_gold', price = 5, label = 'Hennessy Gold' },
			{ object = 'atr_set_drinks_barefoot_sa', price = 5, label = 'Barefoot' },
			{ object = 'atr_set_drinks_hennessy_original_nba', price = 5, label = 'Hennessy original nba' },
			{ object = 'atr_set_drinks_hennessy_vsop', price = 5, label = 'Hennessy vsop' },
			{ object = 'set_drinks_jack_daniel', price = 5, label = 'Jack daniel' },
			{ object = 'set_drinks_jack_daniel_berry', price = 5, label = 'Jack daniel B' },
			{ object = 'set_drinks_jack_daniel_coca', price = 5, label = 'Jack daniel C' },
			{ object = 'set_drinks_jack_daniel_d', price = 5, label = 'Jack daniel D' },
			{ object = 'set_drinks_jack_daniel_l', price = 20, label = 'Jack daniel E' },
			{ object = 'set_drinks_jack_daniel_peach', price = 20, label = 'Jack daniel F' },
			{ object = 'atr_set_drinks_remy_martin', price = 5, label = 'Remy martin' },
			{ object = 'atr_set_drinks_skyy', price = 5, label = 'Sky' },
			{ object = 'atr_set_drinks_skyy_b', price = 4, label = 'Sky B' },
			{ object = 'atr_set_drinks_skyy_c', price = 7, label = 'Sky C' },
			{ object = 'atr_set_drinks_skyy_d', price = 5, label = 'Sky D' },
			{ object = 'atr_set_drinks_skyy_e', price = 5, label = 'Sky E' },
			{ object = 'atr_set_drinks_skyy_f', price = 5, label = 'Sky F' },
			{ object = 'atr_set_drinks_smirnoff', price = 5, label = 'Smirnoff' },
			{ object = 'atr_set_drinks_smirnoff_rasperry', price = 20, label = 'Smirnoff B' },
			{ object = 'set_drinks_stella', price = 5, label = 'Stella' },
			{ object = 'set_drinks_stella_black', price = 5, label = 'Stella B' },
			{ object = 'set_drinks_stella_rosa', price = 4, label = 'Stella C' },
			{ object = 'set_drinks_tanqueray', price = 7, label = 'Tanqueray' },
			{ object = 'atr_set_drinks_taylor_port', price = 20, label = 'Taylor port' },
			{ object = 'atr_set_drinks_barefoot_m', price = 5, label = 'Barefoot B' },
			{ object = 'atr_set_drinks_barefoot_p', price = 5, label = 'Barefoot C' },
			{ object = 'atr_set_drinks_barefoot_pi', price = 5, label = 'Barefoot D' },
			{ object = 'atr_set_drinks_barefoot_s', price = 5, label = 'Barefoot E' },
			{ object = 'atr_set_drinks_barefoot_ss', price = 5, label = 'Barefoot F' },
			{ object = 'atr_rug_myworld', price = 5, label = 'Rug myworld' },
			{ object = 'atr_rug_slut', price = 5, label = 'Rug slut' },
			{ object = 'atr_rug_you', price = 5, label = 'Rug you' },
			{ object = 'atr_living_book', price = 5, label = 'Book' },
			{ object = 'atr_living_candles', price = 5, label = 'Candles' },
			{ object = 'atr_living_empty_v', price = 5, label = 'Empty vase' },
			{ object = 'atr_living_flower', price = 5, label = 'Flower' },
			{ object = 'atr_living_marshall', price = 5, label = 'Speaker Marshall' },
			{ object = 'atr_living_plant', price = 5, label = 'Plant' },
			{ object = 'atr_living_shelf', price = 5, label = 'Shelf' },
			{ object = 'atr_bunny_basket', price = 5, label = 'Basket' },
			{ object = 'atr_egg_holder', price = 5, label = 'Egg holder' },
			{ object = 'atr_happy_candy', price = 5, label = 'Candy' },
			{ object = 'atr_happy_eggs', price = 5, label = 'Eggs' },
		}
	},
	sofas = {
		label = 'Sofas',
