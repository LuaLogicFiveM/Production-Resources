...
CL.IsAllowedCityhall = function(jobName, storeId)
    ...
    if Config.Core == "ESX" then
        if stores[storeId].owner == PlayerData.identifier then
            return {
                ['resumes'] = true,
                ['taxes'] = true
            }
    ...
    elseif Config.Core == "QB-Core" then
        if stores[storeId].owner == PlayerData.citizenid then
            return {
                ['resumes'] = true,
                ['taxes'] = true
            }
...
--  █ █ ▄▀▄ █▀▄ █ ▄▀▄ ██▄ █   ██▀ ▄▀▀
--  ▀▄▀ █▀█ █▀▄ █ █▀█ █▄█ █▄▄ █▄▄ ▄██
---@class menu: 'shelf-menu', 'checkout-menu', 'management-menu', 'purchase-menu', 'basket'
CL.AllowedToUse = function(menu)
    if menu == 'shelf-menu' then -- Shelf menu
        -- Your custom logic
        
    elseif menu == 'checkout-menu' then -- Checkout / Receipt menu
        -- Your custom logic
        
    elseif menu == 'management-menu' then -- Management menu
        -- Your custom logic

    elseif menu == 'purchase-menu' then -- Purchase Store menu
        -- Your custom logic

    elseif menu == 'basket' then -- Take basket
        -- Your custom logic
