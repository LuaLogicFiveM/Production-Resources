...
RegisterNetEvent('ulc:server:enteredVehicle')
AddEventHandler('ulc:server:enteredVehicle', function()
  local src = source
...
RegisterNetEvent('ulc:server:exitedVehicle')
AddEventHandler('ulc:server:exitedVehicle', function()
  local src = source
