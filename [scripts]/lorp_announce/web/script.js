...
window.addEventListener("message", (event) => {
  ...
  if (item.type === "anuncio") {
    ...
    setTimeout(() => {
      ...
      fetch(`https://lorp_announce/closeAnnouncement`, {
      method: "POST",
      headers: {
...
function createAnnounce() {
  ...
  fetch(`https://lorp_announce/createAnnounce`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
function markOnGPS() {
  fetch(`https://lorp_announce/marcarGPS`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
function closeCreateInterface() {
  ...
  fetch(`https://lorp_announce/closeCreateInterface`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
