...
SvConfig.PickPocket = {
    ...
    lootTables = {
        [0] = {
            ...
            lootTable = {
                COMMON = {
                    { name = 'money', min = 10, max = 10 },
                },
                RARE = {
                    { name = 'phone', min = 1, max = 1 },
                    { name = 'money', min = 100, max = 100 },
                },
                EPIC = {
                    { name = 'gold_coin', min = 1, max = 3 },
                }
            },
            guaranteedRarities = {}
        },
...
SvConfig.Mail = {
    ...
    envelopeLootTable = {
        ...
        lootTable = {
            COMMON = {
                { name = 'letter', min = 1, max = 1 },
            },
            RARE = {
                { name = 'money', min = 10, max = 30 },
            },
        },
        -- what type of loot categories are forced none if empty, example { COMMON = 2, EPIC = 1}
        guaranteedRarities = {},
    ...
    letterNpc = {
        ...
        minLocationTime = 360, -- [[ minutes ]]
        -- how long ped stays in one location (in minutes)
        maxLocationTime = 640, -- [[ minutes ]]
        locations = {
            {name = 'Vespucci', coords = vector4(-1122.4, -1445.8, 4.1, 163.8)},
            {name = 'Prosperity', coords = vector4(-1022.5, -1022.6, 1.2, 25.8)},
            {name = 'Cougar', coords = vector4(-1489.7, -325.2, 45.9, 181.0)},
            {name = 'Bay City', coords = vector4(-1082.9, -1673.8, 3.7, 353.7)},
        },
    },
...
SvConfig.PorchPirate = {
    ...
    packageRegenerationTime = 2, -- [[ minutes ]]
    ...
    progressBar = {
        text = locale("progress.porch_pirate.grab_package"), -- The progress bar text when picking up a package
        duration = 3000, -- [[ milliseconds ]] -- The length of the progress bar in seconds
        disable = { disableMovement = true, disableCarMovement = true }, -- What controls/movement to disable during the progress bar
        anim = { -- The animation when picking up a package
    ...
    lootTables = {
        small = {
            ...
            lootTable = {
                ...
                RARE = {
                    ...
                    { name = 'atm_hack_device', min = 1, max = 1 },
                    { name = 'atm_bomb', min = 1, max = 1 }
                },
                EPIC = {
                    { name = 'seeds_weed_1a', min = 1, max = 1 },
                    { name = 'seeds_weed_1b', min = 1, max = 1 }
                },
                LEGENDARY = {
            ...
            glitterBombPercentage = 0
        },
        medium = {
            weight = 35,
            -- what item is required to open the packages (optional)
            openingItem = {"weapon_knife","weapon_switchblade"},
        ...
        large = {
            ...
            lootTable = {
                COMMON = {
                    { name = 'money', min = 100, max = 700 }
                },
                RARE = {
                    { name = 'weapon_scanner', min = 1, max = 1 },
                    { name = 'lockpick', min = 1, max = 1 }
                },
                EPIC = {
                    { name = 'seeds_weed_1a', min = 1, max = 1 },
                    { name = 'seeds_weed_1b', min = 1, max = 1 },
                    { name = 'atm_reader', min = 1, max = 1 }
                }
            },
            -- what type of loot categories are forced none if empty, example { COMMON = 2, EPIC = 1}
            guaranteedRarities = {},
