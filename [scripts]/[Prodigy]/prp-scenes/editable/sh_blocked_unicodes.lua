...
local blockedRanges = {
    ...
    {0x000024C2, 0x0001F251}, -- WARNING: this broad range covers CJK Unified Ideographs (U+4E00–U+9FFF), CJK Extension A (U+3400–U+4DBF), CJK Compatibility Ideographs (U+F900–U+FAFF), and CJK Radicals (U+2E80–U+2FDF) — Chinese/Japanese/Korean characters are blocked here
...
local blockedSingles = saveInTable {
    0x000000A9,
    0x000000AE,
    0x0000203C,
    0x00002049,
    ...
    0x00002B50,
    0x00002B55,
    0x00003030, -- CJK: Wavy Dash
    0x0000303D, -- CJK: Part Alternation Mark
    0x00003297, -- CJK: Circled Ideograph Congratulation
    0x00003299, -- CJK: Circled Ideograph Secret
    0x0001F004,
    0x0001F0CF,
    -- unicode 7
    0x0001F6F3,
