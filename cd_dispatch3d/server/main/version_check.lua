CreateThread(function()
    ...
    local docs_link = 'https://docs.codesign.pro/paid-scripts/dispatch3d/changelog'
    local download_link = 'https://portal.cfx.re/assets/granted-assets?search=cd_dispatch3d'
