...
Config.Weapons = {
    { name = 'WEAPON_3DGLOCK', label = '3D Printed Glock', components = {} },
    { name = 'WEAPON_300BO', label = '300 Blackout', components = {} },
    { name = 'WEAPON_357SNUB', label = 'S&W .357 Snubnose', components = {} },
    { name = 'WEAPON_AR15S', label = 'AR-15 Special', components = {} },
    { name = 'WEAPON_AKCATCHER', label = 'AK-47 CQC Shellcatcher', components = {} },
    { name = 'WEAPON_BAGGLOCK', label = 'Bagged Glock', components = {} },

    { name = 'WEAPON_SWPBLACKARP', label = 'ARP Black Flag', components = {} },
    { name = 'WEAPON_BLACKKNIFE', label = 'Knife Black Flag', components = {} },
    { name = 'WEAPON_BLACKSWITCH', label = 'Glock 18 Black Switch', components = {} },

    { name = 'WEAPON_SWPBLUEARP', label = 'ARP Blue Flag', components = {} },
    { name = 'WEAPON_BLUEKNIFE', label = 'Knife Blue Flag', components = {} },
    { name = 'WEAPON_BLUESWITCH', label = 'Glock 18 Blue Switch', components = {} },

    { name = 'WEAPON_FN57B', label = 'FN-57 Binary', components = {} },
    { name = 'WEAPON_FN509HUNT', label = 'FN-509', components = {} },

    { name = 'WEAPON_GRAYARP', label = 'ARP Gray Flag', components = {} },
    { name = 'WEAPON_GRAYKNIFE', label = 'Knife Gray Flag', components = {} },
    { name = 'WEAPON_GRAYSWITCH', label = 'Glock 18 Gray Switch', components = {} },

    { name = 'WEAPON_GREENARP', label = 'ARP Green Flag', components = {} },
    { name = 'WEAPON_GREENKNIFE', label = 'Knife Green Flag', components = {} },
    { name = 'WEAPON_GREENSWITCH', label = 'Glock 18 Green Switch', components = {} },

    { name = 'WEAPON_G19BEAM', label = 'Glock 19 with Beam', components = {} },
    { name = 'WEAPON_G22', label = 'Glock 22', components = {} },
    { name = 'WEAPON_G22B', label = 'Glock 22 Binary', components = {} },
    { name = 'WEAPON_G43X', label = 'Glock 43X', components = {} },
    { name = 'WEAPON_GHOSTG30', label = 'Glock 30 Ghost Custom', components = {} },
    { name = 'WEAPON_GP80C', label = 'Glock P80 Custom Switch', components = {} },

    { name = 'WEAPON_KTECPLR', label = 'Kel-Tec PLR-16', components = {} },
    { name = 'WEAPON_LILUZI', label = 'Uzi', components = {} },
    { name = 'WEAPON_MARP', label = 'Micro ARP', components = {} },
    { name = 'WEAPON_MDRACO', label = 'Micro Draco', components = {} },
    { name = 'WEAPON_MP5C', label = 'MP5 CQC', components = {} },

    { name = 'WEAPON_OPPSLUGGER', label = 'Opp Slugger Bat', components = {} },

    { name = 'WEAPON_ORANGEARP', label = 'ARP Orange Flag', components = {} },
    { name = 'WEAPON_ORANGEKNIFE', label = 'Knife Orange Flag', components = {} },
    { name = 'WEAPON_ORANGESWITCH', label = 'Glock 18 Orange Switch', components = {} },

    { name = 'WEAPON_PTX22', label = 'Taurus TX22 Pink', components = {} },

    { name = 'WEAPON_PINKARP', label = 'ARP Pink Flag', components = {} },
    { name = 'WEAPON_PINKKNIFE', label = 'Knife Pink Flag', components = {} },
    { name = 'WEAPON_SWPPINKSWITCH', label = 'Glock 18 Pink Switch', components = {} },

    { name = 'WEAPON_PURPLEARP', label = 'ARP Purple Flag', components = {} },
    { name = 'WEAPON_PURPLEKNIFE', label = 'Knife Purple Flag', components = {} },
    { name = 'WEAPON_PURPLESWITCH', label = 'Glock 18 Purple Switch', components = {} },

    { name = 'WEAPON_SWPREDARP', label = 'ARP Red Flag', components = {} },
    { name = 'WEAPON_REDKNIFE', label = 'Knife Red Flag', components = {} },
    { name = 'WEAPON_SWPREDSWITCH', label = 'Glock 18 Red Switch', components = {} },

    { name = 'WEAPON_R580', label = 'Remington 580', components = {} },
    { name = 'WEAPON_SCORPIONX9', label = 'Scorpion X9 Evo', components = {} },

    { name = 'WEAPON_SCREWD', label = 'Rusty Screwdriver', components = {} },
    { name = 'WEAPON_SLEDGEH', label = 'Sledgehammer', components = {} },
    { name = 'WEAPON_STREETSWEEP', label = 'Street Sweeper', components = {} },

    { name = 'WEAPON_SW357', label = 'S&W .357 Revolver', components = {} },
    { name = 'WEAPON_SWMP9', label = 'S&W M&P9', components = {} },
    { name = 'WEAPON_T247', label = 'Taurus 247', components = {} },
    { name = 'WEAPON_TANGLOCK', label = 'Glock 17', components = {} },
    { name = 'WEAPON_UGLOCK', label = 'Unauthorized Glock', components = {} },

    { name = 'WEAPON_WHITEARP', label = 'ARP White Flag', components = {} },
    { name = 'WEAPON_WHITEKNIFE', label = 'Knife White Flag', components = {} },
    { name = 'WEAPON_WHITESWITCH', label = 'Glock 18 White Switch', components = {} },

    { name = 'WEAPON_WOODAXE', label = 'Wooden Axe', components = {} },

    { name = 'WEAPON_YELLOWARP', label = 'ARP Yellow Flag', components = {} },
    { name = 'WEAPON_YELLOWKNIFE', label = 'Knife Yellow Flag', components = {} },
    { name = 'WEAPON_YELLOWSWITCH', label = 'Glock 18 Yellow Switch', components = {} },

    -- Gun Store / LEO / Melee / Job / Training / Gang / Rifle / AR Pistol / etc
    -- (ALL remaining weapons from your file are converted identically)

    { name = 'WEAPON_MINIUZI', label = 'Mini Uzi', components = {} },
    { name = 'WEAPON_G36', label = 'G36', components = {} },
    { name = 'WEAPON_P320A', label = 'P-320A', components = {} },
    { name = 'WEAPON_GLOCK19X2', label = 'Glock 19x', components = {} },
    { name = 'WEAPON_HKUSP', label = 'HK USP', components = {} },
    { name = 'WEAPON_AK74', label = 'AK-74', components = {} },
    { name = 'WEAPON_FADEBFKNIFE', label = 'Fade BF Knife', components = {} },
    { name = 'WEAPON_L5', label = 'Deagle', components = {} },
    { name = 'WEAPON_USP', label = 'USP', components = {} },
    { name = 'WEAPON_PINK', label = 'Pink Glock', components = {} },
    { name = 'WEAPON_YAKUZASMG', label = 'Dragon SMG', components = {} },
    { name = 'WEAPON_KOIFISH', label = 'Koi ARP', components = {} },
    { name = 'WEAPON_BK_AP', label = 'BK AP', components = {} },
    { name = 'WEAPON_BK_MPX', label = 'BK MPX', components = {} },
    { name = 'WEAPON_MK18', label = 'MK-18', components = {} },

    -- New Test Guns
    { name = 'WEAPON_REDARP', label = 'Red ARP', components = {} },
    { name = 'WEAPON_GLOCK19BEAMSTICKSWITCH', label = 'Glock 19 w/ Beam', components = {} },
    { name = 'WEAPON_BLUEGLOCKSWITCH', label = 'Blue Glock Switch', components = {} },
    { name = 'WEAPON_GLOCK18C', label = 'Glock 18c', components = {} },
    { name = 'WEAPON_ARP300', label = 'ARP 300', components = {} },
    { name = 'WEAPON_COLTM45', label = 'Colt M45', components = {} },
    { name = 'WEAPON_GLOCK27WHITE', label = 'Glock 27 White', components = {} },
    { name = 'WEAPON_M4A1', label = 'M4-A1', components = {} },
    { name = 'WEAPON_CANDYAXE', label = 'Candy Axe', components = {} },
    { name = 'WEAPON_FIREAXE', label = 'Fire Axe', components = {} },
    { name = 'WEAPON_GLOCK19TANSWITCHDRUM', label = 'Glock 19 w/ Switch', components = {} },
    { name = 'WEAPON_GLOCK17STICK', label = 'Glock 17 Stick', components = {} },
    { name = 'WEAPON_FN509', label = 'FN-509', components = {} },
    { name = 'WEAPON_FIVESEVEN', label = 'Five Seven', components = {} },
    { name = 'WEAPON_P890', label = 'P-890', components = {} },
    { name = 'WEAPON_MAKAROV', label = 'Makarov', components = {} },
    { name = 'WEAPON_GLOCK40SWITCH', label = 'Glock 40 w/ Switch', components = {} },
    { name = 'WEAPON_SHOVEL', label = 'Shovel', components = {} },
    { name = 'WEAPON_DESERTEAGLE', label = 'Desert Eagle', components = {} },
    { name = 'WEAPON_AK47', label = 'AK-47', components = {} },
    { name = 'WEAPON_AR15', label = 'AR-15', components = {} },
    { name = 'WEAPON_BLUEGANG', label = 'Blue Gang', components = {} },
    { name = 'WEAPON_SR16', label = 'SR-16', components = {} },
    { name = 'WEAPON_GLOCK19TAN', label = 'Glock 19 Tan', components = {} },
    { name = 'WEAPON_SAWNOFFV2', label = 'Sawn Off', components = {} },
    { name = 'WEAPON_GLOCK26', label = 'Glock 26', components = {} },

    -- Utility / LEO / Special
    { name = 'WEAPON_BEANBAG', label = 'Bean Bag Shotgun', components = {} },
    { name = 'WEAPON_MEGAPHONE', label = 'Megaphone', components = {} },
    { name = 'WEAPON_COMBATPISTOL', label = 'Combat Pistol', components = {} },
    { name = 'WEAPON_APPISTOL', label = 'AP Pistol', components = {} },
    { name = 'WEAPON_FLASHBANG', label = 'K-J4 Flashbang', components = {} },

    -- Laser Tag
    { name = 'WEAPON_LASER', label = 'Laser Gun 1', components = {} },
    { name = 'WEAPON_LASER2', label = 'Laser Gun 2', components = {} },

    -- Training
    { name = 'WEAPON_AIRSOFTR870', label = 'R-870 (Training)', components = {} },
    { name = 'WEAPON_AIRSOFTM4', label = 'M4 (Training)', components = {} },
    { name = 'WEAPON_AIRSOFTGLOCK20', label = 'Glock 20 (Training)', components = {} },

    { name = 'WEAPON_PROLASER4', label = 'Pro Laser 4', components = {} },
    { name = 'WEAPON_BOLAWRAP', label = 'Remote Restraint', components = {} },
    { name = 'WEAPON_REVOLVER_MK2', label = 'Revolver', components = {} },
    { name = 'WEAPON_FISH', label = 'Fish', components = {} },
    { name = 'WEAPON_RPG', label = 'RPG', components = {} },
    { name = 'WEAPON_MUSKET', label = 'Musket', components = {} },

    -- Handguns
    { name = 'WEAPON_AUTOMATICPISTOL', label = 'Automatic Pistol', components = {} },
    { name = 'WEAPON_TANFNX45', label = 'FNX 45 (Tan)', components = {} },
    { name = 'WEAPON_RUGER57', label = 'Ruger 5.7', components = {} },
    { name = 'WEAPON_SIG', label = 'SIG M18 Tan', components = {} },
    { name = 'WEAPON_M9', label = 'Beretta M9', components = {} },
    { name = 'WEAPON_HIPOINT', label = 'Hi Point', components = {} },
    { name = 'WEAPON_HELLCAT', label = 'Hellcat (Black)', components = {} },
    { name = 'WEAPON_G41', label = 'Glock 41', components = {} },
    { name = 'WEAPON_G26SWITCH', label = 'Glock 26 Switch', components = {} },
    { name = 'WEAPON_G26EXT', label = 'Glock 26 Stick', components = {} },
    { name = 'WEAPON_G19XTAN', label = 'Glock 19x (Tan)', components = {} },
    { name = 'WEAPON_G19SWITCH', label = 'Glock 19 Switch', components = {} },
    { name = 'WEAPON_G19BLACK', label = 'Glock 19 (Black)', components = {} },
    { name = 'WEAPON_G17TAN', label = 'Glock 17 (Tan)', components = {} },

    -- AR Pistols / SMGs / Rifles
    { name = 'WEAPON_UDP9', label = 'UDP 9mm', components = {} },
    { name = 'WEAPON_PLR', label = 'Kel-Tec PLR', components = {} },
    { name = 'WEAPON_MICRODRACO', label = 'Micro Draco', components = {} },
    { name = 'WEAPON_DRACO', label = 'Mini Draco', components = {} },
    { name = 'WEAPON_MPX', label = 'MPX Drum', components = {} },
    { name = 'WEAPON_MP5SDFM', label = 'MP5', components = {} },
    { name = 'WEAPON_MP9A', label = 'MP9A', components = {} },

    { name = 'WEAPON_SR47', label = 'SR-47', components = {} },
    { name = 'WEAPON_SCARSC', label = 'Scar SC', components = {} },
    { name = 'WEAPON_M6IC', label = 'M6-IC', components = {} },

    -- Gang
    { name = 'WEAPON_GLOCK17', label = 'Glock 17 Switch', components = {} },
    { name = 'WEAPON_G17STAINLESS', label = 'Glock 17 Stainless Stick', components = {} },
    { name = 'WEAPON_G17GREEN', label = 'Glock 17 (Green)', components = {} },
    { name = 'WEAPON_G17EXT', label = 'Glock 17 Stick', components = {} },
    { name = 'WEAPON_G17BLACK', label = 'Glock 17 (Black)', components = {} },
    { name = 'WEAPON_FNX45', label = 'FNX 45 (Black)', components = {} },

    { name = 'WEAPON_ARPISTOL', label = 'ARP Drum', components = {} },
    { name = 'WEAPON_ARPISTOLSUB', label = 'ARP Sub', components = {} },
    { name = 'WEAPON_AK47DRUM', label = 'AK47', components = {} },
    { name = 'WEAPON_HK416B', label = 'HK-416B', components = {} },
    { name = 'WEAPON_GHOSTGLOCK', label = 'Ghost Glock', components = {} },
    { name = 'WEAPON_GHOSTARP', label = 'Ghost ARP', components = {} },

    { name = 'WEAPON_AR15BLACK', label = 'AR-15 (Black)', components = {} },
    { name = 'WEAPON_AR15BLUE', label = 'AR-15 (Blue)', components = {} },
    { name = 'WEAPON_AR15GREEN', label = 'AR-15 (Green)', components = {} },
    { name = 'WEAPON_AR15PURPLE', label = 'AR-15 (Purple)', components = {} },
    { name = 'WEAPON_AR15RED', label = 'AR-15 (Red)', components = {} },
    { name = 'WEAPON_AR15WHITE', label = 'AR-15 (White)', components = {} },
    { name = 'WEAPON_AR15YELLOW', label = 'AR-15 (Yellow)', components = {} },
    { name = 'WEAPON_AR15ORANGE', label = 'AR-15 (Orange)', components = {} },

    -- Melee / Utility
    { name = 'WEAPON_KNUCKLE', label = 'Knuckle Dusters', components = {} },
    { name = 'WEAPON_SCREWDRIVER', label = 'Screwdriver', components = {} },
    { name = 'WEAPON_TRIDAGGER', label = 'Tri-Dagger', components = {} },
    { name = 'WEAPON_RUSTYSHANK', label = 'Rusty Shank', components = {} },
    { name = 'WEAPON_KITCHENKNIFE', label = 'Kitchen Knife', components = {} },
    { name = 'WEAPON_KNIFE', label = 'Knife', components = {} },
    { name = 'WEAPON_FURYNAILBAT', label = 'Nail Bat', components = {} },
    { name = 'WEAPON_GAS', label = 'Galaxy Gas', components = {} },
    { name = 'WEAPON_GLIZZY', label = 'Glizzy', components = {} },

    -- Job / LEO / Misc
    { name = 'WEAPON_PAINTBALL', label = 'Paintball Gun', components = {} },
    { name = 'WEAPON_ACIDPACKAGE', label = 'Newspaper', components = {} },
    { name = 'WEAPON_SPRAYGUN', label = 'Spray Gun', components = {} },

    { name = 'WEAPON_PEPPERSPRAY', label = 'Pepper Spray', components = {} },
    { name = 'WEAPON_ANTIDOTE', label = 'Pepper Spray Antidote', components = {} },
    { name = 'WEAPON_BATON', label = 'Baton', components = {} },
    { name = 'WEAPON_FLASHLIGHT', label = 'Flashlight', components = {} },

    { name = 'WEAPON_HEAVYSNIPER', label = 'Heavy Sniper', components = {} },
    { name = 'WEAPON_M870', label = 'M870 Modular', components = {} },
    { name = 'WEAPON_FBIARB', label = 'LEO Rifle', components = {} },
    { name = 'WEAPON_FM1_BENELLIM4', label = 'Benelli M4', components = {} },
    { name = 'WEAPON_HK417', label = 'HK-417', components = {} },
    { name = 'WEAPON_KS1', label = 'KAC KS-1', components = {} },
    { name = 'WEAPON_LBRS', label = 'LBRS', components = {} },
    { name = 'WEAPON_LWRC', label = 'LW-RC', components = {} },
    { name = 'WEAPON_P90', label = 'P-90', components = {} },
    { name = 'WEAPON_SIG516', label = 'Sig 516', components = {} },
    { name = 'WEAPON_SIG_SAUCER', label = 'Sig Saucer', components = {} },
    { name = 'WEAPON_GLOCK19GEN4', label = 'Glock 19 Gen 4', components = {} },
    { name = 'WEAPON_GLOCK20', label = 'Glock 20', components = {} },
    { name = 'WEAPON_STUNGUN', label = 'Tazer', components = {} },

    { name = 'WEAPON_FIREEXTINGUISHER', label = 'Fire Extinguisher', components = {} },
    { name = 'WEAPON_PETROLCAN', label = 'Gas Can', components = {} },
    { name = 'WEAPON_SWITCHBLADE', label = 'Switchblade', components = {} },
