local interiors = {
    ...
    --------------------------------------
    {
        ...
        entitySets = {
            ...
            { name = 'lights_02_plantset', enable = false },
            ...
            { name = 'gunroom_gate_03', enable = true },   -- metal wire | (S)
            { name = 'gunroom_gate_d_01', enable = false }, -- metal | (B)
            { name = 'gunroom_gate_d_02', enable = false },  -- metal grid with glass | (B)
            { name = 'gunroom_gate_d_03', enable = true }, -- metal wire | (S)
            -- SECROOM
            { name = 'sec_screens', enable = true },    -- editable screens | (B)
            -- BAR
            { name = 'bar_logo_01', enable = false },    -- 3 emissive logo on the bar center
            { name = 'bar_logo_02', enable = false },    -- emissive logo on front of the counter
            { name = 'bar_logo_01_b', enable = true },  -- 3 logo on the bar center
            { name = 'bar_logo_02_b', enable = true },  -- logo on front of the counter
            { name = 'stair_lights_01', enable = false },    -- white lights next to the stairs | (B)
            { name = 'stair_lights_02', enable = false },   -- violet blue lights next to the stairs | (B)
            { name = 'stair_lights_03', enable = true },   -- magenta lights next to the stairs | (B)
            ...
            { name = 'bar_stageset_03', enable = true },   -- a stage in front of the stairs with magenta lights
            { name = 'bar_stageset_i', enable = true },    -- instruments for the stageset
            { name = 'bar_stageset_i_piano', enable = false },  -- only piano for the stageset
            { name = 'bar_normalset', enable = false },  -- siting area in front of the stairs
            -- PLANTER
            ...
            { name = 'p_plant_lett', enable = true },  -- planted lettuce with frame | (B/S)
            ...
            { name = 'office_logo_03', enable = false },
