return {
	...
	['blueprint'] = {
		label = 'Blueprint',
		description = 'This is able to be used at crafting tables to unlock certain weapons',
		weight = 100,
		stack = false,
	},

	['blueprint_uzi'] = {
		label = 'Mini Uzi Blueprint',
		weight = 100,
		stack = false,
		client = {
			image = 'blueprint.png'
	...
	['blueprint_glock19beam'] = {
		label = 'Glock 19 w/ Beam Blueprint',
		weight = 100,
		stack = false,
		client = {
			image = 'blueprint.png'
	...
	['blueprint_blueglockswitch'] = {
		label = 'Blue Glock Switch Blueprint',
		weight = 100,
		stack = false,
		client = {
			image = 'blueprint.png'
	...
	['blueprint_GLOCK27WHITE'] = {
		label = 'Glock 27 White Blueprint',
		weight = 100,
		stack = false,
		client = {
			image = 'blueprint.png'
	...
	['blueprint_glock19switch'] = {
		label = 'Glock 19 w/ Switch Blueprint',
		weight = 100,
		stack = false,
		client = {
			image = 'blueprint.png'
	...
	['blueprint_glock17stick'] = {
		label = 'Glock 17 Stick Blueprint',
		weight = 100,
		stack = false,
		client = {
			image = 'blueprint.png'
	...
	['rifle_upper'] = {
		label = 'Rifle Upper (1/4)',
		description = 'This is the first of four weapon parts you need to craft a rifle',
		weight = 100,
		stack = true,
	},

	['rifle_lower'] = {
		label = 'Rifle Lower (2/4)',
		description = 'This is the second of four weapon parts you need to craft a rifle',
		weight = 100,
		stack = true,
	},

	['rifle_bolt'] = {
		label = 'Rifle Bolt (3/4)',
		description = 'This is the third of four weapon parts you need to craft a rifle',
		weight = 100,
		stack = true,
	},

	['rifle_stock'] = {
		label = 'Rifle Stock (4/4)',
		description = 'This is the fourth of four weapon parts you need to craft a rifle',
		weight = 100,
		stack = true,
	},

	['handgun_lower'] = {
		label = 'Handgun Lower (1/4)',
		description = 'This is the first of four weapon parts you need to craft a handgun',
		weight = 100,
		stack = true,
	},

	['handgun_slide'] = {
		label = 'Handgun Slide (2/4)',
		description = 'This is the second of four weapon parts you need to craft a handgun',
		weight = 100,
		stack = true,
	},

	['handgun_barrel'] = {
		label = 'Handgun Barrel (3/4)',
		description = 'This is the third of four weapon parts you need to craft a handgun',
		weight = 100,
		stack = true,
	},

	['handgun_trigger'] = {
		label = 'Handgun Trigger (4/4)',
		description = 'This is the fourth of four weapon parts you need to craft a handgun',
		weight = 100,
		stack = true,
	},

	['arpistol_upper'] = {
		label = 'AR Pistol Upper (1/4)',
		description = 'This is the first of four weapon parts you need to craft a ar pistol',
		weight = 100,
		stack = true,
	},

	['arpistol_lower'] = {
		label = 'AR Pistol Lower (2/4)',
		description = 'This is the second of four weapon parts you need to craft a ar pistol',
		weight = 100,
		stack = true,
	},

	['arpistol_trigger'] = {
		label = 'AR Pistol Trigger (3/4)',
		description = 'This is the third of four weapon parts you need to craft a ar pistol',
		weight = 100,
		stack = true,
	},

	['arpistol_grip'] = {
		label = 'AR Pistol Grip (4/4)',
		description = 'This is the fourth of four weapon parts you need to craft a ar pistol',
		weight = 100,
		stack = true,
	},
	...
	['radio'] = {
		...
		consume = 0,
		client = {
			event = 'ak47_radio:client:open',
			remove = function(total)
				if total < 1 then
					exports.ak47_radio:removePlayerFromRadio()
				end
			end
		},
	},
